...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def loadEnvironment(self):
        ...
        self.betweenBattleMusic = base.loadMusic('phase_7/audio/bgm/encntr_suit_winning.ogg')
        self.battleOneMusic = base.loadMusic('phase_9/audio/bgm/encntr_suit_winning.ogg')
        self.battleTwoMusic = base.loadMusic('phase_7/audio/bgm/encntr_suit_winning.ogg')
