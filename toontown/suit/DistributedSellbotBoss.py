...
class DistributedSellbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def loadEnvironment(self):
        ...
        self.promotionMusic = base.loadMusic('phase_9/audio/bgm/encntr_head_suit_theme.mp3')
        self.betweenBattleMusic = base.loadMusic('phase_9/audio/bgm/encntr_toon_winning.ogg')
        self.battleTwoMusic = base.loadMusic('phase_7/audio/bgm/encntr_suit_winning_indoor.mp3')
