...
suitProperties = {'f': (4.0 / cSize, SuitDNA.corpPolyColor, ['flunky', 'glasses'], '', 4.88),
                  ...
                  'hh': (6.5 / aSize, VBase4(0.95, 0.95, 1.0, 1.0), ['headhunter'], '', 7.45),
                  'cr': (6.75 / cSize, VBase4(0.95, 0.95, 1.0, 1.0), ['flunky'], 'corporate-raider.jpg', 8.23),
                  ...
                  'pp': (3.55 / aSize, VBase4(0.95, 0.95, 1.0, 1.0), ['pennypincher'], '', 5.26),
                  'tw': (4.5 / cSize, SuitDNA.moneyPolyColor, ['tightwad'], '', 5.41),
                  'bc': (4.4 / bSize, SuitDNA.moneyPolyColor, ['beancounter'], '', 5.95),
                  'nc': (5.25 / aSize, VBase4(0.95, 0.95, 1.0, 1.0), ['numbercruncher'], '', 7.22),
                  'mb': (5.3 / cSize, SuitDNA.moneyPolyColor, ['moneybags'], '', 6.97),
                  'ls': (6.5 / bSize, VBase4(0.5, 0.85, 0.75, 1.0), ['loanshark'], '', 8.58),
                  'rb': (7.0 / aSize, VBase4(0.95, 0.95, 1.0, 1.0), ['yesman'], 'robber-baron.jpg', 8.95),
                  # Sellbots
                  'cc': (3.5 / cSize, VBase4(0.55, 0.65, 1.0, 1.0), ['coldcaller'], '', 4.63),
                  'tm': (3.75 / bSize, SuitDNA.salesPolyColor, ['telemarketer'], '', 5.24),
                  'nd': (4.35 / aSize, VBase4(0.95, 0.95, 1.0, 1.0), ['numbercruncher'], 'name-dropper.jpg', 5.98),
                  'gh': (4.75 / cSize, SuitDNA.salesPolyColor, ['gladhander'], '', 6.4),
                  'ms': (4.75 / bSize, SuitDNA.salesPolyColor, ['movershaker'], '', 6.7),
                  'tf': (5.25 / aSize, VBase4(0.95, 0.95, 1.0, 1.0), ['twoface'], '', 6.95),
                  'm': (5.75 / aSize, VBase4(0.95, 0.95, 1.0, 1.0), ['twoface'], 'mingler.jpg', 7.61),
                  'mh': (7.0 / aSize, VBase4(0.95, 0.95, 1.0, 1.0), ['yesman', 'glasses'], '', 8.95),
                  }
