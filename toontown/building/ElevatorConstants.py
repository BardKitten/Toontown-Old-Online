...
ElevatorData = {ELEVATOR_NORMAL: {'openTime': 1.0,
                   'closeTime': 1.0,
                   'width': 3.5,
                   'countdown': bboard.get('elevatorCountdown', 15.0),
                   'sfxVolume': 1.0,
                   'collRadius': 5},
 ELEVATOR_VP: {'openTime': 1.0,
               'closeTime': 1.0,
               'width': 11.5,
               'countdown': bboard.get('elevatorCountdown', 30.0),
               'sfxVolume': 0.7,
               'collRadius': 7.5},
 ELEVATOR_MINT: {'openTime': 1.0,
                 'closeTime': 1.0,
                 'width': 5.875,
                 'countdown': bboard.get('elevatorCountdown', 15.0),
                 'sfxVolume': 1.0,
                 'collRadius': 5},
 ELEVATOR_OFFICE: {'openTime': 1.0,
                   'closeTime': 1.0,
                   'width': 5.875,
                   'countdown': bboard.get('elevatorCountdown', 15.0),
                   'sfxVolume': 1.0,
                   'collRadius': 5},
 ELEVATOR_CFO: {'openTime': 1.0,
                'closeTime': 1.0,
                'width': 8.166,
                'countdown': bboard.get('elevatorCountdown', 30.0),
                'sfxVolume': 0.7,
                'collRadius': 7.5},
 ELEVATOR_CJ: {'openTime': 1.0,
               'closeTime': 1.0,
               'width': 15.8,
               'countdown': bboard.get('elevatorCountdown', 30.0),
               'sfxVolume': 0.7,
               'collRadius': 7.5},
 ELEVATOR_STAGE: {'openTime': 1.0,
                  'closeTime': 1.0,
                  'width': 6.5,
                  'countdown': bboard.get('elevatorCountdown', 15.0),
                  'sfxVolume': 1.0,
                  'collRadius': 9.5},
 ELEVATOR_BB: {'openTime': 1.0,
               'closeTime': 1.0,
               'width': 6.3,
               'countdown': bboard.get('elevatorCountdown', 30.0),
               'sfxVolume': 0.7,
               'collRadius': 7.5},
 ELEVATOR_COUNTRY_CLUB: {'openTime': 1.0,
                         'closeTime': 1.0,
                         'width': 5.875,
                         'countdown': bboard.get('elevatorCountdown', 15.0),
                         'sfxVolume': 1.0,
                         'collRadius': 4},
 ELEVATOR_FIELD: {'openTime': 1.0,
                   'closeTime': 1.0,
                   'width': 3.5,
                   'countdown': bboard.get('elevatorCountdown', 15.0),
                   'sfxVolume': 1.0,
