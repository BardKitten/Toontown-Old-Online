...
QuestDict = {
    ...
    160: (TT_TIER, OBSOLETE, (CogTrackQuest, ToontownGlobals.ToontownCentral, 5, 'c'), Same, ToonHQ, NA, 175, TTLocalizer.QuestDialogDict[160]),
    161: (TT_TIER, OBSOLETE, (CogTrackQuest, ToontownGlobals.ToontownCentral, 5, 'l'), Same, ToonHQ, NA, 175, TTLocalizer.QuestDialogDict[161]),
    162: (TT_TIER, OBSOLETE, (CogTrackQuest, ToontownGlobals.ToontownCentral, 5, 's'), Same, ToonHQ, NA, 175, TTLocalizer.QuestDialogDict[162]),
    163: (TT_TIER, OBSOLETE, (CogTrackQuest, ToontownGlobals.ToontownCentral, 5, 'm'), Same, ToonHQ, NA, 175, TTLocalizer.QuestDialogDict[163]),
    ...
    165: (TT_TIER + 1, Start, (CogQuest, Anywhere, 2, Any), 2001, Same, NA, (166, 167, 168, 169), TTLocalizer.QuestDialogDict[165]),
    166: (TT_TIER + 1, Cont, (CogTrackQuest, Anywhere, 2, 'c'), Same, Same, NA, 170, TTLocalizer.QuestDialogDict[166]),
    167: (TT_TIER + 1, Cont, (CogTrackQuest, Anywhere, 2, 'l'), Same, Same, NA, 170, TTLocalizer.QuestDialogDict[167]),
    168: (TT_TIER + 1, Cont, (CogTrackQuest, Anywhere, 2, 's'), Same, Same, NA, 170, TTLocalizer.QuestDialogDict[168]),
    169: (TT_TIER + 1, Cont, (CogTrackQuest, Anywhere, 2, 'm'), Same, Same, NA, 170, TTLocalizer.QuestDialogDict[169]),
    ...
    1001: (TT_TIER + 2, Start, (CogQuest, ToontownGlobals.ToontownCentral, 6, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    1005: (TT_TIER + 2, Start, (CogQuest, Anywhere, 4, 'f'), Any, ToonHQ, Any, NA, DefaultDialog),
    1006: (TT_TIER + 2, Start, (CogQuest, Anywhere, 3, 'pp'), Any, ToonHQ, Any, NA, DefaultDialog),
    1007: (TT_TIER + 2, Start, (CogQuest, Anywhere, 4, 'bf'), Any, ToonHQ, Any, NA, DefaultDialog),
    1008: (TT_TIER + 2, Start, (CogQuest, Anywhere, 3, 'tm'), Any, ToonHQ, Any, NA, DefaultDialog),
    1009: (TT_TIER + 2, Start, (CogQuest, Anywhere, 4, 'sc'), Any, ToonHQ, Any, NA, DefaultDialog),
    1010: (TT_TIER + 2, Start, (CogQuest, Anywhere, 2, 'tw'), Any, ToonHQ, Any, NA, DefaultDialog),
    1011: (TT_TIER + 2, Start, (CogQuest, Anywhere, 4, 'cc'), Any, ToonHQ, Any, NA, DefaultDialog),
    1012: (TT_TIER + 2, Start, (CogQuest, Anywhere, 2, 'nd'), Any, ToonHQ, Any, NA, DefaultDialog),
    1013: (TT_TIER + 2, Start, (CogQuest, Anywhere, 3, 'p'), Any, ToonHQ, Any, NA, DefaultDialog),
    1014: (TT_TIER + 2, Start, (CogQuest, Anywhere, 2, 'ym'), Any, ToonHQ, Any, NA, DefaultDialog),
    1015: (TT_TIER + 2, Start, (CogQuest, Anywhere, 3, 'b'), Any, ToonHQ, Any, NA, DefaultDialog),
    1016: (TT_TIER + 2, Start, (CogQuest, Anywhere, 2, 'dt'), Any, ToonHQ, Any, NA, DefaultDialog),
    1017: (TT_TIER + 2, Start, (CogQuest, Anywhere, 1, 'mm'), Any, ToonHQ, Any, NA, DefaultDialog),
    1018: (TT_TIER + 2, Start, (CogQuest, Anywhere, 1, 'gh'), Any, ToonHQ, Any, NA, DefaultDialog),
    1019: (TT_TIER + 2, Start, (CogQuest, Anywhere, 1, 'bc'), Any, ToonHQ, Any, NA, DefaultDialog),
    1020: (TT_TIER + 2, Start, (CogQuest, Anywhere, 1, 'ac'), Any, ToonHQ, Any, NA, DefaultDialog),
    1021: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 4, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    1022: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 4, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    1023: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 3, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    1024: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 3, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    1025: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 2, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    1026: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 1, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    1027: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 3, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    1028: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 3, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    1029: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 3, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    1030: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 3, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    1031: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 2, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    1032: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 2, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    1033: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 2, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    1034: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 2, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    1035: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 1, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    1036: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 1, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    1037: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 1, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    1038: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 1, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    1044: (TT_TIER + 2, Cont, (RecoverItemQuest, Anywhere, 2, 2, VeryEasy, Any, 'type'), Same, Same, NA, 1045, TTLocalizer.QuestDialogDict[1044]),
    ...
    1047: (TT_TIER + 2, Start, (RecoverItemQuest, Anywhere, 2, 3, VeryEasy, 'm', 'track'), 2127, Same, NA, 1048, TTLocalizer.QuestDialogDict[1047]),
    1048: (TT_TIER + 2, Cont, (DeliverItemQuest, 9), Same, 2131, NA, 1049, TTLocalizer.QuestDialogDict[1048]),
    1049: (TT_TIER + 2, Cont, (RecoverItemQuest, Anywhere, 2, 2007, VeryEasy, 5, 'level'), Same, Same, NA, 1053, TTLocalizer.QuestDialogDict[1049]),
    ...
    1057: (TT_TIER + 2, Cont, (CogLevelQuest, ToontownGlobals.ToontownCentral, 3, 4), Same, Same, NA, 1058, TTLocalizer.QuestDialogDict[1057]),
    ...
    1061: (TT_TIER + 2, Cont, (CogQuest, ToontownGlobals.ToontownCentral, 1, 'nc'), Same, Same, 101, NA, TTLocalizer.QuestDialogDict[1061]),
    1062: (TT_TIER + 2, Cont, (CogQuest, ToontownGlobals.ToontownCentral, 2, 'ac'), Same, Same, 101, NA, TTLocalizer.QuestDialogDict[1062]),
    900: (TT_TIER + 3, Start, (VisitQuest,), Any, 2201, NA, 1063, TTLocalizer.QuestDialogDict[900]),
    1063: (TT_TIER + 3, Start, (RecoverItemQuest, Anywhere, 1, 13, Medium, 2, 'level'), 2201, Same, NA, 1067, TTLocalizer.QuestDialogDict[1063]),
    ...
    1079: (TT_TIER + 2, Cont, (RecoverItemQuest, Anywhere, 2, 15, Easy, 'b'), Same, 2217, NA, 1080, TTLocalizer.QuestDialogDict[1079]),
    1092: (TT_TIER + 2, Cont, (RecoverItemQuest, Anywhere, 2, 15, Easy, 'pp'), Same, 2217, NA, 1080, TTLocalizer.QuestDialogDict[1092]),
    ...
    1086: (TT_TIER + 2, Start, (RecoverItemQuest, Anywhere, 2, 2007, Easy, 4, 'level'), 2003, Same, NA, 1089, TTLocalizer.QuestDialogDict[1086]),
    ...
    1091: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 1, 5), 2119, ToonHQ, 101, NA, TTLocalizer.QuestDialogDict[1091]),
    1100: (TT_TIER + 2, Start, (CogQuest, ToontownGlobals.ToontownCentral, 5, Any), Any, ToonHQ, NA, 1101, DefaultDialog),
    1101: (TT_TIER + 2, Cont, (DeliverItemQuest, 1000), Any, 2004, 1000, NA, DefaultDialog),
    1102: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 3, 3), Any, ToonHQ, NA, 1103, DefaultDialog),
    1103: (TT_TIER + 2, Cont, (DeliverItemQuest, 1000), Any, 2004, 1000, NA, DefaultDialog),
    1105: (TT_TIER + 2, Start, (CogQuest, Anywhere, 4, 'p'), Any, ToonHQ, Any, NA, DefaultDialog),
    1106: (TT_TIER + 2, Start, (CogQuest, Anywhere, 4, 'b'), Any, ToonHQ, Any, NA, DefaultDialog),
    1107: (TT_TIER + 2, Start, (CogQuest, Anywhere, 4, 'pp'), Any, ToonHQ, Any, NA, DefaultDialog),
    1108: (TT_TIER + 2, Start, (CogQuest, Anywhere, 4, 'tm'), Any, ToonHQ, Any, NA, DefaultDialog),
    1109: (TT_TIER + 2, Start, (CogQuest, Anywhere, 3, 'ym'), Any, ToonHQ, Any, NA, DefaultDialog),
    1110: (TT_TIER + 2, Start, (CogQuest, Anywhere, 3, 'dt'), Any, ToonHQ, Any, NA, DefaultDialog),
    1111: (TT_TIER + 2, Start, (CogQuest, Anywhere, 3, 'tw'), Any, ToonHQ, Any, NA, DefaultDialog),
    1112: (TT_TIER + 2, Start, (CogQuest, Anywhere, 3, 'nd'), Any, ToonHQ, Any, NA, DefaultDialog),
    1205: (TT_TIER + 3, Start, (CogQuest, Anywhere, 2, 'mm'), Any, ToonHQ, Any, NA, DefaultDialog),
    1206: (TT_TIER + 3, Start, (CogQuest, Anywhere, 2, 'ac'), Any, ToonHQ, Any, NA, DefaultDialog),
    1207: (TT_TIER + 3, Start, (CogQuest, Anywhere, 2, 'bc'), Any, ToonHQ, Any, NA, DefaultDialog),
    1208: (TT_TIER + 3, Start, (CogQuest, Anywhere, 2, 'gh'), Any, ToonHQ, Any, NA, DefaultDialog),
    1209: (TT_TIER + 3, Start, (CogQuest, Anywhere, 1, 'ds'), Any, ToonHQ, Any, NA, DefaultDialog),
    1210: (TT_TIER + 3, Start, (CogQuest, Anywhere, 1, 'bs'), Any, ToonHQ, Any, NA, DefaultDialog),
    1211: (TT_TIER + 3, Start, (CogQuest, Anywhere, 1, 'nc'), Any, ToonHQ, Any, NA, DefaultDialog),
    1212: (TT_TIER + 3, Start, (CogQuest, Anywhere, 1, 'ms'), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    2001: (DD_TIER, Start, (CogQuest, Anywhere, 2, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2002: (DD_TIER, Start, (CogQuest, Anywhere, 2, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2003: (DD_TIER, Start, (CogQuest, Anywhere, 3, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2004: (DD_TIER, Start, (CogQuest, Anywhere, 3, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2005: (DD_TIER, Start, (CogQuest, Anywhere, 4, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2006: (DD_TIER, Start, (CogQuest, Anywhere, 4, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2007: (DD_TIER, Start, (CogQuest, Anywhere, 5, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2008: (DD_TIER, Start, (CogQuest, Anywhere, 5, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2009: (DD_TIER, Start, (CogQuest, Anywhere, 6, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2010: (DD_TIER, Start, (CogLevelQuest, Anywhere, 5, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    2011: (DD_TIER, Start, (CogLevelQuest, Anywhere, 5, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    2012: (DD_TIER, Start, (CogLevelQuest, Anywhere, 4, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    2013: (DD_TIER, Start, (CogLevelQuest, Anywhere, 4, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    2014: (DD_TIER, Start, (CogLevelQuest, Anywhere, 3, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    2015: (DD_TIER, Start, (CogLevelQuest, Anywhere, 3, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    2816: (DD_TIER, Start, (CogLevelQuest, Anywhere, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    2817: (DD_TIER, Start, (CogLevelQuest, Anywhere, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    2818: (DD_TIER, Start, (CogLevelQuest, Anywhere, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    2819: (DD_TIER, Start, (CogLevelQuest, Anywhere, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    2101: (DD_TIER + 1, Start, (CogQuest, ToontownGlobals.DonaldsDock, 5, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2102: (DD_TIER + 1, Start, (CogQuest, ToontownGlobals.DonaldsDock, 5, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2103: (DD_TIER + 1, Start, (CogQuest, ToontownGlobals.DonaldsDock, 5, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2104: (DD_TIER + 1, Start, (CogQuest, Anywhere, 5, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2105: (DD_TIER + 1, Start, (CogQuest, Anywhere, 5, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2106: (DD_TIER + 1, Start, (CogQuest, Anywhere, 5, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2107: (DD_TIER + 1, Start, (CogQuest, Anywhere, 6, 'f'), Any, ToonHQ, Any, NA, DefaultDialog),
    2108: (DD_TIER + 1, Start, (CogQuest, Anywhere, 5, 'p'), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    2114: (DD_TIER + 1, Start, (CogQuest, Anywhere, 5, 'tm'), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    2120: (DD_TIER + 1, Start, (CogQuest, Anywhere, 5, 'pp'), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    2126: (DD_TIER + 1, Start, (CogQuest, Anywhere, 5, 'b'), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    2131: (DD_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.DonaldsDock, 5, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    2132: (DD_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.DonaldsDock, 5, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    2133: (DD_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.DonaldsDock, 4, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    2134: (DD_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.DonaldsDock, 4, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    2135: (DD_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.DonaldsDock, 3, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    2136: (DD_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.DonaldsDock, 3, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    2137: (DD_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.DonaldsDock, 2, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    2138: (DD_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.DonaldsDock, 1, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    2143: (DD_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.DonaldsDock, 2, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    2144: (DD_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.DonaldsDock, 2, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    2145: (DD_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.DonaldsDock, 2, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    2146: (DD_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.DonaldsDock, 2, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    2147: (DD_TIER + 1, Start, (CogTrackQuest, Anywhere, 6, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    2148: (DD_TIER + 1, Start, (CogTrackQuest, Anywhere, 6, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    2149: (DD_TIER + 1, Start, (CogTrackQuest, Anywhere, 6, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    2150: (DD_TIER + 1, Start, (CogTrackQuest, Anywhere, 6, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    2151: (DD_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 1, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    2152: (DD_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 1, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    2153: (DD_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 1, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    2154: (DD_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 1, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    2155: (DD_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'm', 2, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    2156: (DD_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 's', 2, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    2157: (DD_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'c', 2, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    2158: (DD_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'l', 2, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    2202: (DD_TIER + 1, Start, (RecoverItemQuest, Anywhere, 1, 2001, Medium, 'tf'), 1101, Same, 101, NA, TTLocalizer.QuestDialogDict[2202]),
    ...
    2205: (DD_TIER + 1, Cont, (RecoverItemQuest, Anywhere, 3, 2003, Medium, 'ym'), Same, Same, NA, 2206, TTLocalizer.QuestDialogDict[2205]),
    ...
    2208: (DD_TIER + 1, Start, (RecoverItemQuest, Anywhere, 2, 2005, Easy, 'ac'), 1201, Same, 701, NA, TTLocalizer.QuestDialogDict[2208]),
    ...
    2211: (DD_TIER + 1, Cont, (CogQuest, ToontownGlobals.DonaldsDock, 1, 'mb'), Same, Same, NA, 2212, TTLocalizer.QuestDialogDict[2211]),
    ...
    2214: (DD_TIER + 1, Cont, (RecoverItemQuest, ToontownGlobals.DonaldsDock, 5, 2007, Hard, Any), Same, Same, NA, 2215, TTLocalizer.QuestDialogDict[2214]),
    ...
    2801: (DD_TIER + 2, Start, (CogQuest, Anywhere, 5, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2802: (DD_TIER + 2, Start, (CogQuest, Anywhere, 5, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2803: (DD_TIER + 2, Start, (CogQuest, Anywhere, 6, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    2806: (DD_TIER + 2, Start, (CogQuest, Anywhere, 7, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2807: (DD_TIER + 2, Start, (CogQuest, Anywhere, 8, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2808: (DD_TIER + 2, Start, (CogQuest, Anywhere, 8, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2809: (DD_TIER + 2, Start, (CogQuest, Anywhere, 9, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    2810: (DD_TIER + 2, Start, (CogLevelQuest, Anywhere, 5, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    2811: (DD_TIER + 2, Start, (CogLevelQuest, Anywhere, 5, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    2812: (DD_TIER + 2, Start, (CogLevelQuest, Anywhere, 4, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    2813: (DD_TIER + 2, Start, (CogLevelQuest, Anywhere, 4, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    2814: (DD_TIER + 2, Start, (CogLevelQuest, Anywhere, 3, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    2815: (DD_TIER + 2, Start, (CogLevelQuest, Anywhere, 3, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    2816: (DD_TIER + 2, Start, (CogLevelQuest, Anywhere, 2, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    2817: (DD_TIER + 2, Start, (CogLevelQuest, Anywhere, 2, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    2818: (DD_TIER + 2, Start, (CogLevelQuest, Anywhere, 2, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    2819: (DD_TIER + 2, Start, (CogLevelQuest, Anywhere, 1, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    2820: (DD_TIER + 2, Start, (CogQuest, Anywhere, 10, Any), Any, ToonHQ, NA, 2821, DefaultDialog),
    ...
    2906: (DD_TIER + 2, Cont, (DeliverGagQuest, 3, ToontownBattleGlobals.SQUIRT_TRACK, 3), Same, Same, NA, 2907, TTLocalizer.QuestDialogDict[2906]),
    ...
    2911: (DD_TIER + 2, Cont, (CogTrackQuest, ToontownGlobals.DonaldsDock, 5, 'm'), Same, Same, NA, 2925, TTLocalizer.QuestDialogDict[2911]),
    2915: (DD_TIER + 2, Cont, (VisitQuest,), Same, 1204, NA, 2916, TTLocalizer.QuestDialog_2910),
    2916: (DD_TIER + 2, Cont, (CogTrackQuest, ToontownGlobals.DonaldsDock, 5, 's'), Same, Same, NA, 2925, TTLocalizer.QuestDialogDict[2916]),
    2920: (DD_TIER + 2, Cont, (VisitQuest,), Same, 1204, NA, 2921, TTLocalizer.QuestDialog_2910),
    2921: (DD_TIER + 2, Cont, (CogTrackQuest, ToontownGlobals.DonaldsDock, 5, 'c'), Same, Same, NA, 2925, TTLocalizer.QuestDialogDict[2921]),
    2925: (DD_TIER + 2, Cont, (DeliverItemQuest, 2012), Same, 1203, NA, 2926, TTLocalizer.QuestDialogDict[2925]),
    2926: (DD_TIER + 2, Cont, (BuildingQuest, ToontownGlobals.DonaldsDock, 1, Any, 3, 0), Same, Same, 900, NA, TTLocalizer.QuestDialogDict[2926]),
    ...
    3103: (DG_TIER, Start, (CogQuest, ToontownGlobals.DaisyGardens, 9, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    3104: (DG_TIER, Start, (CogQuest, Anywhere, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    3105: (DG_TIER, Start, (CogQuest, Anywhere, 12, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    3106: (DG_TIER, Start, (CogQuest, Anywhere, 12, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    3107: (DG_TIER, Start, (CogQuest, Anywhere, 7, 'f'), Any, ToonHQ, Any, NA, DefaultDialog),
    3108: (DG_TIER, Start, (CogQuest, Anywhere, 6, 'p'), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    3111: (DG_TIER, Start, (CogQuest, Anywhere, 3, 'ds'), Any, ToonHQ, Any, NA, DefaultDialog),
    3112: (DG_TIER, Start, (CogQuest, Anywhere, 2, 'hh'), Any, ToonHQ, Any, NA, DefaultDialog),
    3113: (DG_TIER, Start, (CogQuest, Anywhere, 6, 'tm'), Any, ToonHQ, Any, NA, DefaultDialog),
    3114: (DG_TIER, Start, (CogQuest, Anywhere, 5, 'nd'), Any, ToonHQ, Any, NA, DefaultDialog),
    3115: (DG_TIER, Start, (CogQuest, Anywhere, 4, 'gh'), Any, ToonHQ, Any, NA, DefaultDialog),
    3116: (DG_TIER, Start, (CogQuest, Anywhere, 3, 'ms'), Any, ToonHQ, Any, NA, DefaultDialog),
    3117: (DG_TIER, Start, (CogQuest, Anywhere, 2, 'tf'), Any, ToonHQ, Any, NA, DefaultDialog),
    3118: (DG_TIER, Start, (CogQuest, Anywhere, 1, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    3119: (DG_TIER, Start, (CogQuest, Anywhere, 7, 'sc'), Any, ToonHQ, Any, NA, DefaultDialog),
    3120: (DG_TIER, Start, (CogQuest, Anywhere, 6, 'pp'), Any, ToonHQ, Any, NA, DefaultDialog),
    3121: (DG_TIER, Start, (CogQuest, Anywhere, 5, 'tw'), Any, ToonHQ, Any, NA, DefaultDialog),
    3122: (DG_TIER, Start, (CogQuest, Anywhere, 4, 'bc'), Any, ToonHQ, Any, NA, DefaultDialog),
    3123: (DG_TIER, Start, (CogQuest, Anywhere, 3, 'nc'), Any, ToonHQ, Any, NA, DefaultDialog),
    3124: (DG_TIER, Start, (CogQuest, Anywhere, 2, 'mb'), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    3127: (DG_TIER, Start, (CogQuest, Anywhere, 5, 'dt'), Any, ToonHQ, Any, NA, DefaultDialog),
    3128: (DG_TIER, Start, (CogQuest, Anywhere, 4, 'ac'), Any, ToonHQ, Any, NA, DefaultDialog),
    3129: (DG_TIER, Start, (CogQuest, Anywhere, 3, 'bs'), Any, ToonHQ, Any, NA, DefaultDialog),
    3130: (DG_TIER, Start, (CogQuest, Anywhere, 2, 'sd'), Any, ToonHQ, Any, NA, DefaultDialog),
    3131: (DG_TIER, Start, (CogLevelQuest, Anywhere, 5, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    3132: (DG_TIER, Start, (CogLevelQuest, Anywhere, 5, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    3133: (DG_TIER, Start, (CogLevelQuest, Anywhere, 4, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    3134: (DG_TIER, Start, (CogLevelQuest, Anywhere, 4, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    3137: (DG_TIER, Start, (CogLevelQuest, Anywhere, 2, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    3138: (DG_TIER, Start, (CogLevelQuest, Anywhere, 1, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    3139: (DG_TIER, Start, (CogTrackQuest, ToontownGlobals.DaisyGardens, 10, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    3140: (DG_TIER, Start, (CogTrackQuest, ToontownGlobals.DaisyGardens, 10, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    3141: (DG_TIER, Start, (CogTrackQuest, ToontownGlobals.DaisyGardens, 10, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    3142: (DG_TIER, Start, (CogTrackQuest, ToontownGlobals.DaisyGardens, 10, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    3147: (DG_TIER, Start, (CogTrackQuest, Anywhere, 8, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    3148: (DG_TIER, Start, (CogTrackQuest, Anywhere, 8, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    3149: (DG_TIER, Start, (CogTrackQuest, Anywhere, 8, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    3150: (DG_TIER, Start, (CogTrackQuest, Anywhere, 8, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    3151: (DG_TIER, Start, (BuildingQuest, Anywhere, 1, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    3152: (DG_TIER, Start, (BuildingQuest, Anywhere, 1, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    3153: (DG_TIER, Start, (BuildingQuest, Anywhere, 1, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    3154: (DG_TIER, Start, (BuildingQuest, Anywhere, 1, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    3155: (DG_TIER, Start, (BuildingQuest, Anywhere, 1, 'm', 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    3156: (DG_TIER, Start, (BuildingQuest, Anywhere, 1, 's', 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    3157: (DG_TIER, Start, (BuildingQuest, Anywhere, 1, 'c', 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    3158: (DG_TIER, Start, (BuildingQuest, Anywhere, 1, 'l', 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    3207: (DG_TIER, Start, (RecoverItemQuest, ToontownGlobals.DaisyGardens, 3, 5004, VeryEasy, 'tf'), 5107, Same, 101, NA, TTLocalizer.QuestDialogDict[3207]),
    3208: (DG_TIER, OBSOLETE, (CogQuest, ToontownGlobals.DaisyGardens, 2, 'ms'), Any, ToonHQ, NA, 3209, TTLocalizer.QuestDialogDict[3208]),
    3209: (DG_TIER, OBSOLETE, (CogQuest, ToontownGlobals.DaisyGardens, 1, 'tf'), Same, Same, 202, NA, TTLocalizer.QuestDialogDict[3209]),
    3247: (DG_TIER, OBSOLETE, (CogQuest, ToontownGlobals.DaisyGardens, 2, 'bs'), Any, ToonHQ, 202, NA, TTLocalizer.QuestDialogDict[3247]),
    ...
    3217: (DG_TIER, Start, (RecoverItemQuest, Anywhere, 3, 5010, VeryEasy, 'ms'), ToonHQ, ToonHQ, NA, 3218, TTLocalizer.QuestDialogDict[3217]),
    3218: (DG_TIER, Cont, (RecoverItemQuest, Anywhere, 2, 5010, VeryHard, 'tf'), Same, Same, NA, 3219, TTLocalizer.QuestDialogDict[3218]),
    3219: (DG_TIER, Cont, (RecoverItemQuest, Anywhere, 1, 5010, Easy, 'm'), Same, Same, 101, NA, TTLocalizer.QuestDialogDict[3219]),
    3244: (DG_TIER, Start, (RecoverItemQuest, Anywhere, 3, 5010, VeryEasy, 'sd'), ToonHQ, ToonHQ, NA, 3245, TTLocalizer.QuestDialogDict[3244]),
    3245: (DG_TIER, Cont, (RecoverItemQuest, Anywhere, 2, 5010, VeryHard, 'le'), Same, Same, NA, 3246, TTLocalizer.QuestDialogDict[3245]),
    3246: (DG_TIER, Cont, (RecoverItemQuest, Anywhere, 1, 5010, VeryHard, 'bw'), Same, Same, 101, NA, TTLocalizer.QuestDialogDict[3246]),
    3220: (DG_TIER, Start, (VisitQuest,), Any, 5207, NA, 3221, TTLocalizer.QuestDialogDict[3220]),
    3221: (DG_TIER, Start, (CogQuest, ToontownGlobals.DaisyGardens, 5, Any), 5207, Same, 100, NA, TTLocalizer.QuestDialogDict[3221]),
    3222: (DG_TIER, Start, (BuildingQuest, Anywhere, 1, Any, 2, 0), ToonHQ, ToonHQ, NA, 3223, TTLocalizer.QuestDialogDict[3222]),
    3223: (DG_TIER, Cont, (BuildingQuest, Anywhere, 1, Any, 3, 0), Same, Same, NA, 3224, TTLocalizer.QuestDialogDict[3223]),
    3224: (DG_TIER, Cont, (BuildingQuest, Anywhere, 1, Any, 4, 0), Same, Same, 501, NA, TTLocalizer.QuestDialogDict[3224]),
    ...
    3235: (DG_TIER, Cont, (CogQuest, ToontownGlobals.DaisyGardens, 5, Any), Same, 5108, 100, NA, TTLocalizer.QuestDialogDict[3235]),
    3236: (DG_TIER, OBSOLETE, (BuildingQuest, Anywhere, 1, 'l', 4, 0), Any, ToonHQ, NA, 3237, TTLocalizer.QuestDialogDict[3236]),
    3237: (DG_TIER, OBSOLETE, (BuildingQuest, Anywhere, 1, 's', 4, 0), Same, Same, 702, NA, TTLocalizer.QuestDialogDict[3237]),
    3238: (DG_TIER, Start, (RecoverItemQuest, Anywhere, 1, 2, VeryEasy, 'tf'), Any, ToonHQ, NA, 3239, TTLocalizer.QuestDialogDict[3238]),
    3239: (DG_TIER, Cont, (RecoverItemQuest, Anywhere, 1, 5012, Hard, 'm'), Same, Same, 302, NA, TTLocalizer.QuestDialogDict[3239]),
    3242: (DG_TIER, Start, (RecoverItemQuest, Anywhere, 1, 2, VeryEasy, 'ac'), Any, ToonHQ, NA, 3243, TTLocalizer.QuestDialogDict[3242]),
    3243: (DG_TIER, Cont, (RecoverItemQuest, Anywhere, 1, 5012, Hard, 'bs'), Same, Same, 302, NA, TTLocalizer.QuestDialogDict[3243]),
    3240: (DG_TIER, OBSOLETE, (RecoverItemQuest, Anywhere, 1, 5009, Hard, 'sd'), Any, 5103, 102, NA, TTLocalizer.QuestDialogDict[3240]),
    3241: (DG_TIER, OBSOLETE, (BuildingQuest, Anywhere, 1, Any, 5, 0), Any, ToonHQ, 102, NA, TTLocalizer.QuestDialogDict[3241]),
    ...
    3263: (DG_TIER, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 10), 5313, 5313, 702, NA, TTLocalizer.QuestDialogDict[3263]),
    3500: (DG_TIER, Start, (CogQuest, ToontownGlobals.DaisyGardens, 10, Any), Any, ToonHQ, NA, 3501, DefaultDialog),
    ...
    3503: (DG_TIER, Start, (RescueQuest, InFO, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    4010: (MM_TIER, Start, (CogQuest, Anywhere, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4011: (MM_TIER, Start, (CogQuest, Anywhere, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4012: (MM_TIER, Start, (CogQuest, Anywhere, 11, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4013: (MM_TIER, Start, (CogQuest, Anywhere, 11, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4014: (MM_TIER, Start, (CogQuest, Anywhere, 12, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4015: (MM_TIER, Start, (CogQuest, Anywhere, 12, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4016: (MM_TIER, Start, (CogQuest, Anywhere, 13, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4017: (MM_TIER, Start, (CogQuest, Anywhere, 13, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4018: (MM_TIER, Start, (CogQuest, Anywhere, 14, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4019: (MM_TIER, Start, (CogQuest, Anywhere, 14, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4020: (MM_TIER, Start, (CogLevelQuest, Anywhere, 5, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    4021: (MM_TIER, Start, (CogLevelQuest, Anywhere, 5, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    4022: (MM_TIER, Start, (CogLevelQuest, Anywhere, 4, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    4023: (MM_TIER, Start, (CogLevelQuest, Anywhere, 4, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    4024: (MM_TIER, Start, (CogLevelQuest, Anywhere, 3, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    4025: (MM_TIER, Start, (CogLevelQuest, Anywhere, 3, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    4026: (MM_TIER, Start, (CogLevelQuest, Anywhere, 2, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    4027: (MM_TIER, Start, (CogLevelQuest, Anywhere, 2, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    4028: (MM_TIER, Start, (CogLevelQuest, Anywhere, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    4029: (MM_TIER, Start, (CogLevelQuest, Anywhere, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    4030: (MM_TIER, Start, (CogQuest, Anywhere, 10, Any), Any, ToonHQ, NA, 4031, DefaultDialog),
    4031: (MM_TIER, Cont, (DeliverItemQuest, 1000), Any, 4008, 1000, NA, DefaultDialog),
    4040: (MM_TIER, Start, (CogQuest, ToontownGlobals.SellbotHQ, 5, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4041: (MM_TIER, Start, (CogQuest, ToontownGlobals.SellbotHQ, 5, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4042: (MM_TIER, Start, (CogLevelQuest, ToontownGlobals.SellbotHQ, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    4043: (MM_TIER, Start, (SkelecogQuest, ToontownGlobals.SellbotFactoryInt, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    4044: (MM_TIER, Start, (RescueQuest, InVP, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    4045: (MM_TIER, Start, (RescueQuest, InFO, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    4101: (MM_TIER + 1, Start, (CogQuest, ToontownGlobals.MinniesMelodyland, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4102: (MM_TIER + 1, Start, (CogQuest, ToontownGlobals.MinniesMelodyland, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4103: (MM_TIER + 1, Start, (CogQuest, ToontownGlobals.MinniesMelodyland, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4104: (MM_TIER + 1, Start, (CogQuest, ToontownGlobals.MinniesMelodyland, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4105: (MM_TIER + 1, Start, (CogQuest, Anywhere, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4106: (MM_TIER + 1, Start, (CogQuest, Anywhere, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4107: (MM_TIER + 1, Start, (CogQuest, Anywhere, 6, 'ym'), Any, ToonHQ, Any, NA, DefaultDialog),
    4108: (MM_TIER + 1, Start, (CogQuest, Anywhere, 5, 'mm'), Any, ToonHQ, Any, NA, DefaultDialog),
    4109: (MM_TIER + 1, Start, (CogQuest, Anywhere, 4, 'ds'), Any, ToonHQ, Any, NA, DefaultDialog),
    4110: (MM_TIER + 1, Start, (CogQuest, Anywhere, 3, 'hh'), Any, ToonHQ, Any, NA, DefaultDialog),
    4111: (MM_TIER + 1, Start, (CogQuest, Anywhere, 2, 'cr'), Any, ToonHQ, Any, NA, DefaultDialog),
    4112: (MM_TIER + 1, Start, (CogQuest, Anywhere, 1, 'tbc'), Any, ToonHQ, Any, NA, DefaultDialog),
    4113: (MM_TIER + 1, Start, (CogQuest, Anywhere, 8, 'cc'), Any, ToonHQ, Any, NA, DefaultDialog),
    4114: (MM_TIER + 1, Start, (CogQuest, Anywhere, 7, 'tm'), Any, ToonHQ, Any, NA, DefaultDialog),
    4115: (MM_TIER + 1, Start, (CogQuest, Anywhere, 6, 'nd'), Any, ToonHQ, Any, NA, DefaultDialog),
    4116: (MM_TIER + 1, Start, (CogQuest, Anywhere, 5, 'gh'), Any, ToonHQ, Any, NA, DefaultDialog),
    4117: (MM_TIER + 1, Start, (CogQuest, Anywhere, 4, 'ms'), None, ToonHQ, Any, NA, DefaultDialog),
    4118: (MM_TIER + 1, Start, (CogQuest, Anywhere, 3, 'tf'), None, ToonHQ, Any, NA, DefaultDialog),
    4119: (MM_TIER + 1, Start, (CogQuest, Anywhere, 7, 'pp'), Any, ToonHQ, Any, NA, DefaultDialog),
    4120: (MM_TIER + 1, Start, (CogQuest, Anywhere, 6, 'tw'), Any, ToonHQ, Any, NA, DefaultDialog),
    4121: (MM_TIER + 1, Start, (CogQuest, Anywhere, 5, 'bc'), Any, ToonHQ, Any, NA, DefaultDialog),
    4122: (MM_TIER + 1, Start, (CogQuest, Anywhere, 4, 'nc'), Any, ToonHQ, Any, NA, DefaultDialog),
    4123: (MM_TIER + 1, Start, (CogQuest, Anywhere, 3, 'mb'), Any, ToonHQ, Any, NA, DefaultDialog),
    4124: (MM_TIER + 1, Start, (CogQuest, Anywhere, 2, 'ls'), Any, ToonHQ, Any, NA, DefaultDialog),
    4125: (MM_TIER + 1, Start, (CogQuest, Anywhere, 6, 'dt'), Any, ToonHQ, Any, NA, DefaultDialog),
    4126: (MM_TIER + 1, Start, (CogQuest, Anywhere, 5, 'ac'), Any, ToonHQ, Any, NA, DefaultDialog),
    4127: (MM_TIER + 1, Start, (CogQuest, Anywhere, 4, 'bs'), Any, ToonHQ, Any, NA, DefaultDialog),
    4128: (MM_TIER + 1, Start, (CogQuest, Anywhere, 3, 'sd'), Any, ToonHQ, Any, NA, DefaultDialog),
    4129: (MM_TIER + 1, Start, (CogQuest, Anywhere, 2, 'le'), Any, ToonHQ, Any, NA, DefaultDialog),
    4130: (MM_TIER + 1, Start, (CogQuest, Anywhere, 1, 'bw'), Any, ToonHQ, Any, NA, DefaultDialog),
    4131: (MM_TIER + 1, Start, (CogLevelQuest, Anywhere, 5, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    4132: (MM_TIER + 1, Start, (CogLevelQuest, Anywhere, 5, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    4133: (MM_TIER + 1, Start, (CogLevelQuest, Anywhere, 4, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    4134: (MM_TIER + 1, Start, (CogLevelQuest, Anywhere, 4, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    4135: (MM_TIER + 1, Start, (CogLevelQuest, Anywhere, 3, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    4136: (MM_TIER + 1, Start, (CogLevelQuest, Anywhere, 3, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    4137: (MM_TIER + 1, Start, (CogLevelQuest, Anywhere, 2, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    4138: (MM_TIER + 1, Start, (CogLevelQuest, Anywhere, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    4143: (MM_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.MinniesMelodyland, 15, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    4144: (MM_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.MinniesMelodyland, 15, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    4145: (MM_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.MinniesMelodyland, 15, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    4146: (MM_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.MinniesMelodyland, 15, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    4147: (MM_TIER + 1, Start, (CogTrackQuest, Anywhere, 15, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    4148: (MM_TIER + 1, Start, (CogTrackQuest, Anywhere, 15, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    4149: (MM_TIER + 1, Start, (CogTrackQuest, Anywhere, 15, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    4150: (MM_TIER + 1, Start, (CogTrackQuest, Anywhere, 15, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    4151: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4152: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4153: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4154: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4155: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'm', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4156: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 's', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4157: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'c', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4158: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'l', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4160: (MM_TIER + 1, Start, (CogQuest, ToontownGlobals.SellbotHQ, 24, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4161: (MM_TIER + 1, Start, (CogQuest, ToontownGlobals.SellbotHQ, 24, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4162: (MM_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.SellbotHQ, 3, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    4165: (MM_TIER + 1, Start, (SkelecogQuest, ToontownGlobals.SellbotFactoryInt, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    4166: (MM_TIER + 1, Start, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    4167: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4168: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4169: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4170: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4171: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 's', 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    4172: (MM_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'l', 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    4204: (MM_TIER + 1, Cont, (CogQuest, ToontownGlobals.MinniesMelodyland, 30, Any), Same, Same, NA, 4205, TTLocalizer.QuestDialogDict[4204]),
    ...
    4208: (MM_TIER + 1, Cont, (DeliverGagQuest, 1, ToontownBattleGlobals.THROW_TRACK, 5), Same, Same, NA, 4209, TTLocalizer.QuestDialogDict[4208]),
    ...
    4212: (MM_TIER + 1, Start, (CogQuest, ToontownGlobals.MinniesMelodyland, 1, 'ls'), 4103, Same, NA, 4213, TTLocalizer.QuestDialogDict[4212]),
    4213: (MM_TIER + 1, Cont, (CogTrackQuest, ToontownGlobals.MinniesMelodyland, 1, 'tbc'), Same, Same, NA, 4214, TTLocalizer.QuestDialogDict[4213]),
    ...
    4216: (MM_TIER + 1, Start, (RecoverItemQuest, Anywhere, 1, 4005, VeryHard, 'tf'), 4302, Same, NA, 4217, TTLocalizer.QuestDialogDict[4216]),
    ...
    4219: (MM_TIER + 1, Cont, (RecoverItemQuest, Anywhere, 1, 4006, VeryHard, 'm'), Same, Same, NA, 4220, TTLocalizer.QuestDialogDict[4219]),
    ...
    4222: (MM_TIER + 1, Cont, (RecoverItemQuest, Anywhere, 1, 4007, VeryHard, 'mh'), Same, Same, NA, 4223, TTLocalizer.QuestDialogDict[4222]),
    ...
    4500: (MM_TIER + 1, Start, (CogQuest, ToontownGlobals.MinniesMelodyland, 10, Any), Any, ToonHQ, NA, 4501, DefaultDialog),
    4501: (MM_TIER + 1, Cont, (DeliverItemQuest, 1000), Any, 4008, 1000, NA, DefaultDialog),
    4502: (MM_TIER + 1, Start, (RescueQuest, InVP, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    4503: (MM_TIER + 1, Start, (RescueQuest, InFO, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    4905: (MM_TIER + 2, Cont, (BuildingQuest, Anywhere, 3, Any, 3, 0), Same, Same, NA, 4906, TTLocalizer.QuestDialogDict[4905]),
    ...
    4908: (MM_TIER + 2, Cont, (BuildingQuest, Anywhere, 2, Any, 4, 0), Same, Same, NA, 4909, TTLocalizer.QuestDialogDict[4908]),
    4909: (MM_TIER + 2, Cont, (BuildingQuest, Anywhere, 1, Any, 5, 0), Same, Same, NA, 4910, TTLocalizer.QuestDialogDict[4909]),
    4910: (MM_TIER + 2, Cont, (DeliverItemQuest, 4011), Same, 4303, 900, NA, TTLocalizer.QuestDialogDict[4910]),
    4810: (MM_TIER + 2, Start, (CogQuest, Anywhere, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4811: (MM_TIER + 2, Start, (CogQuest, Anywhere, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    4814: (MM_TIER + 2, Start, (CogQuest, Anywhere, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4815: (MM_TIER + 2, Start, (CogQuest, Anywhere, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4816: (MM_TIER + 2, Start, (CogQuest, Anywhere, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4817: (MM_TIER + 2, Start, (CogQuest, Anywhere, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4818: (MM_TIER + 2, Start, (CogQuest, Anywhere, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4819: (MM_TIER + 2, Start, (CogQuest, Anywhere, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    4820: (MM_TIER + 2, Start, (CogLevelQuest, Anywhere, 5, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    4821: (MM_TIER + 2, Start, (CogLevelQuest, Anywhere, 5, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    4822: (MM_TIER + 2, Start, (CogLevelQuest, Anywhere, 4, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    4823: (MM_TIER + 2, Start, (CogLevelQuest, Anywhere, 4, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    4824: (MM_TIER + 2, Start, (CogLevelQuest, Anywhere, 3, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    4825: (MM_TIER + 2, Start, (CogLevelQuest, Anywhere, 3, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    4826: (MM_TIER + 2, Start, (CogLevelQuest, Anywhere, 2, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    4827: (MM_TIER + 2, Start, (CogLevelQuest, Anywhere, 2, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    4828: (MM_TIER + 2, Start, (CogLevelQuest, Anywhere, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    4829: (MM_TIER + 2, Start, (CogLevelQuest, Anywhere, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    4830: (MM_TIER + 2, Start, (CogQuest, Anywhere, 5, Any), Any, ToonHQ, NA, 4831, DefaultDialog),
    ...
    4842: (MM_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.SellbotHQ, 5, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    4843: (MM_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 2, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    4847: (MM_TIER + 2, Start, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    4848: (MM_TIER + 2, Start, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    4849: (MM_TIER + 2, Start, (RescueQuest, InVP, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    4850: (MM_TIER + 2, Start, (RescueQuest, InFO, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    5247: (BR_TIER, Start, (VisitQuest,), Any, 3112, NA, 5248, TTLocalizer.QuestDialogDict[5247]),
    5248: (BR_TIER, Start, (CogLevelQuest, Anywhere, 1, 12), 3112, Same, NA, 5249, TTLocalizer.QuestDialogDict[5248]),
    5249: (BR_TIER, Cont, (RecoverItemQuest, Anywhere, 1, 3018, VeryHard, AnyFish), Same, Same, NA, (5250, 5258, 5259, 5260), TTLocalizer.QuestDialogDict[5249]),
    5250: (BR_TIER, Cont, (BuildingQuest, Anywhere, 1, 'l', 5, 0), Same, Same, NA, (5001, 5002, 5003, 5004, 5005, 5006, 5007, 5008), TTLocalizer.QuestDialogDict[5250]),
    5258: (BR_TIER, Cont, (BuildingQuest, Anywhere, 1, 'c', 5, 0), Same, Same, NA, (5001, 5002, 5003, 5004, 5005, 5006, 5007, 5008), TTLocalizer.QuestDialogDict[5258]),
    5259: (BR_TIER, Cont, (BuildingQuest, Anywhere, 1, 'm', 5, 0), Same, Same, NA, (5001, 5002, 5003, 5004, 5005, 5006, 5007, 5008), TTLocalizer.QuestDialogDict[5259]),
    5260: (BR_TIER, Cont, (BuildingQuest, Anywhere, 1, 's', 5, 0), Same, Same, NA, (5001, 5002, 5003, 5004, 5005, 5006, 5007, 5008), TTLocalizer.QuestDialogDict[5260]),
    ...
    5020: (BR_TIER, Start, (CogQuest, Anywhere, 14, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5021: (BR_TIER, Start, (CogQuest, Anywhere, 14, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5022: (BR_TIER, Start, (CogQuest, Anywhere, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5023: (BR_TIER, Start, (CogQuest, Anywhere, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5024: (BR_TIER, Start, (CogQuest, Anywhere, 16, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5025: (BR_TIER, Start, (CogQuest, Anywhere, 16, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5026: (BR_TIER, Start, (CogQuest, Anywhere, 17, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5027: (BR_TIER, Start, (CogQuest, Anywhere, 17, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5028: (BR_TIER, Start, (CogQuest, Anywhere, 18, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5029: (BR_TIER, Start, (CogQuest, Anywhere, 18, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5030: (BR_TIER, Start, (CogLevelQuest, Anywhere, 5, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    5031: (BR_TIER, Start, (CogLevelQuest, Anywhere, 5, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    5032: (BR_TIER, Start, (CogLevelQuest, Anywhere, 4, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    5033: (BR_TIER, Start, (CogLevelQuest, Anywhere, 4, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    5034: (BR_TIER, Start, (CogLevelQuest, Anywhere, 3, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    5035: (BR_TIER, Start, (CogLevelQuest, Anywhere, 3, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    5036: (BR_TIER, Start, (CogLevelQuest, Anywhere, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5037: (BR_TIER, Start, (CogLevelQuest, Anywhere, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5038: (BR_TIER, Start, (CogLevelQuest, Anywhere, 1, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    5039: (BR_TIER, Start, (CogLevelQuest, Anywhere, 1, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    5040: (BR_TIER, Start, (CogQuest, ToontownGlobals.TheBrrrgh, 15, Any), Any, ToonHQ, NA, 5041, DefaultDialog),
    ...
    5071: (BR_TIER, Start, (CogQuest, ToontownGlobals.SellbotHQ, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5072: (BR_TIER, Start, (CogLevelQuest, ToontownGlobals.SellbotHQ, 30, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    5073: (BR_TIER, Start, (CogLevelQuest, ToontownGlobals.SellbotHQ, 30, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    5074: (BR_TIER, Start, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 20, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    5075: (BR_TIER, Start, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 20, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    5076: (BR_TIER, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5077: (BR_TIER, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5078: (BR_TIER, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5079: (BR_TIER, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5080: (BR_TIER, Start, (SkelecogLevelQuest, ToontownGlobals.SellbotFactoryInt, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5081: (BR_TIER, Start, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5082: (BR_TIER, Start, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5083: (BR_TIER, Start, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5084: (BR_TIER, Start, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5085: (BR_TIER, Start, (RescueQuest, InVP, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    5086: (BR_TIER, Start, (RescueQuest, InFO, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    5101: (BR_TIER + 1, Start, (CogQuest, ToontownGlobals.TheBrrrgh, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5102: (BR_TIER + 1, Start, (CogQuest, ToontownGlobals.TheBrrrgh, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5103: (BR_TIER + 1, Start, (CogQuest, ToontownGlobals.TheBrrrgh, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5104: (BR_TIER + 1, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5105: (BR_TIER + 1, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5106: (BR_TIER + 1, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5107: (BR_TIER + 1, Start, (CogQuest, Anywhere, 6, 'ym'), Any, ToonHQ, Any, NA, DefaultDialog),
    5108: (BR_TIER + 1, Start, (CogQuest, Anywhere, 5, 'mm'), Any, ToonHQ, Any, NA, DefaultDialog),
    5109: (BR_TIER + 1, Start, (CogQuest, Anywhere, 4, 'ds'), Any, ToonHQ, Any, NA, DefaultDialog),
    5110: (BR_TIER + 1, Start, (CogQuest, Anywhere, 3, 'hh'), Any, ToonHQ, Any, NA, DefaultDialog),
    5111: (BR_TIER + 1, Start, (CogQuest, Anywhere, 2, 'cr'), Any, ToonHQ, Any, NA, DefaultDialog),
    5112: (BR_TIER + 1, Start, (CogQuest, Anywhere, 1, 'tbc'), Any, ToonHQ, Any, NA, DefaultDialog),
    5113: (BR_TIER + 1, Start, (CogQuest, Anywhere, 6, 'nd'), Any, ToonHQ, Any, NA, DefaultDialog),
    5114: (BR_TIER + 1, Start, (CogQuest, Anywhere, 5, 'gh'), Any, ToonHQ, Any, NA, DefaultDialog),
    5115: (BR_TIER + 1, Start, (CogQuest, Anywhere, 4, 'ms'), Any, ToonHQ, Any, NA, DefaultDialog),
    5116: (BR_TIER + 1, Start, (CogQuest, Anywhere, 3, 'tf'), Any, ToonHQ, Any, NA, DefaultDialog),
    5117: (BR_TIER + 1, Start, (CogQuest, Anywhere, 2, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    5118: (BR_TIER + 1, Start, (CogQuest, Anywhere, 1, 'mh'), Any, ToonHQ, Any, NA, DefaultDialog),
    5119: (BR_TIER + 1, Start, (CogQuest, Anywhere, 6, 'tw'), Any, ToonHQ, Any, NA, DefaultDialog),
    5120: (BR_TIER + 1, Start, (CogQuest, Anywhere, 5, 'bc'), Any, ToonHQ, Any, NA, DefaultDialog),
    5121: (BR_TIER + 1, Start, (CogQuest, Anywhere, 4, 'nc'), Any, ToonHQ, Any, NA, DefaultDialog),
    5122: (BR_TIER + 1, Start, (CogQuest, Anywhere, 3, 'mb'), Any, ToonHQ, Any, NA, DefaultDialog),
    5123: (BR_TIER + 1, Start, (CogQuest, Anywhere, 2, 'ls'), Any, ToonHQ, Any, NA, DefaultDialog),
    5124: (BR_TIER + 1, Start, (CogQuest, Anywhere, 1, 'rb'), Any, ToonHQ, Any, NA, DefaultDialog),
    5125: (BR_TIER + 1, Start, (CogQuest, Anywhere, 6, 'dt'), Any, ToonHQ, Any, NA, DefaultDialog),
    5126: (BR_TIER + 1, Start, (CogQuest, Anywhere, 5, 'ac'), Any, ToonHQ, Any, NA, DefaultDialog),
    5127: (BR_TIER + 1, Start, (CogQuest, Anywhere, 4, 'bs'), Any, ToonHQ, Any, NA, DefaultDialog),
    5128: (BR_TIER + 1, Start, (CogQuest, Anywhere, 3, 'sd'), Any, ToonHQ, Any, NA, DefaultDialog),
    5129: (BR_TIER + 1, Start, (CogQuest, Anywhere, 2, 'le'), Any, ToonHQ, Any, NA, DefaultDialog),
    5130: (BR_TIER + 1, Start, (CogQuest, Anywhere, 1, 'bw'), Any, ToonHQ, Any, NA, DefaultDialog),
    5131: (BR_TIER + 1, Start, (CogLevelQuest, Anywhere, 5, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    5132: (BR_TIER + 1, Start, (CogLevelQuest, Anywhere, 4, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    5133: (BR_TIER + 1, Start, (CogLevelQuest, Anywhere, 4, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    5134: (BR_TIER + 1, Start, (CogLevelQuest, Anywhere, 3, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    5135: (BR_TIER + 1, Start, (CogLevelQuest, Anywhere, 3, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    5136: (BR_TIER + 1, Start, (CogLevelQuest, Anywhere, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5137: (BR_TIER + 1, Start, (CogLevelQuest, Anywhere, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5138: (BR_TIER + 1, Start, (CogLevelQuest, Anywhere, 1, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    5139: (BR_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.TheBrrrgh, 5, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    5140: (BR_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.TheBrrrgh, 5, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    5141: (BR_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.TheBrrrgh, 5, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    5142: (BR_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.TheBrrrgh, 5, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    5143: (BR_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.TheBrrrgh, 5, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    5144: (BR_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.TheBrrrgh, 5, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    5145: (BR_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.TheBrrrgh, 5, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    5146: (BR_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.TheBrrrgh, 5, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    5147: (BR_TIER + 1, Start, (CogTrackQuest, Anywhere, 15, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    5148: (BR_TIER + 1, Start, (CogTrackQuest, Anywhere, 15, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    5149: (BR_TIER + 1, Start, (CogTrackQuest, Anywhere, 15, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    5150: (BR_TIER + 1, Start, (CogTrackQuest, Anywhere, 15, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    5151: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 2, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    5152: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 2, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    5153: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 2, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    5154: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 2, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    5155: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'm', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    5156: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 's', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    5157: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'c', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    5158: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'l', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    5160: (BR_TIER + 1, Start, (CogQuest, ToontownGlobals.SellbotHQ, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5161: (BR_TIER + 1, Start, (CogQuest, ToontownGlobals.SellbotHQ, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5162: (BR_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.SellbotHQ, 24, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    5163: (BR_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.SellbotHQ, 24, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    5164: (BR_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 1, 14), Any, ToonHQ, Any, NA, DefaultDialog),
    5165: (BR_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 1, 14), Any, ToonHQ, Any, NA, DefaultDialog),
    5166: (BR_TIER + 1, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5167: (BR_TIER + 1, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5168: (BR_TIER + 1, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5169: (BR_TIER + 1, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5170: (BR_TIER + 1, Start, (SkelecogQuest, ToontownGlobals.SellbotFactoryInt, 20), Any, ToonHQ, Any, NA, DefaultDialog),
    5171: (BR_TIER + 1, Start, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5172: (BR_TIER + 1, Start, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5173: (BR_TIER + 1, Start, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5174: (BR_TIER + 1, Start, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5176: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5177: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5178: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5179: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 's', 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5180: (BR_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'l', 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5200: (BR_TIER + 1, Start, (VisitQuest,), Any, 3110, NA, (5201, 5261, 5262, 5263), TTLocalizer.QuestDialogDict[5200]),
    5201: (BR_TIER + 1, Start, (RecoverItemQuest, Anywhere, 1, 3001, VeryHard, 'tbc'), 3110, Same, 100, NA, TTLocalizer.QuestDialogDict[5201]),
    5261: (BR_TIER + 1, Start, (RecoverItemQuest, Anywhere, 1, 3001, VeryHard, 'mh'), 3110, Same, 100, NA, TTLocalizer.QuestDialogDict[5261]),
    5262: (BR_TIER + 1, Start, (RecoverItemQuest, Anywhere, 1, 3001, VeryHard, 'rb'), 3110, Same, 100, NA, TTLocalizer.QuestDialogDict[5262]),
    5263: (BR_TIER + 1, Start, (RecoverItemQuest, Anywhere, 1, 3001, VeryHard, 'bw'), 3110, Same, 100, NA, TTLocalizer.QuestDialogDict[5263]),
    ...
    5207: (BR_TIER + 1, Cont, (BuildingQuest, Anywhere, 2, Any, 3, 0), Same, Same, NA, 5208, TTLocalizer.QuestDialogDict[5207]),
    5208: (BR_TIER + 1, Cont, (VisitQuest,), Same, 3114, NA, 5209, TTLocalizer.QuestDialogDict[5208]),
    5209: (BR_TIER + 1, Cont, (CogLevelQuest, Anywhere, 3, 9), Same, Same, 204, NA, TTLocalizer.QuestDialogDict[5209]),
    ...
    5213: (BR_TIER + 1, Cont, (RecoverItemQuest, ToontownGlobals.TheBrrrgh, 20, 3005, Hard, Any), Same, Same, NA, 5214, TTLocalizer.QuestDialogDict[5213]),
    5214: (BR_TIER + 1, Cont, (VisitQuest,), Same, 3119, NA, 5215, TTLocalizer.QuestDialogDict[5214]),
    5215: (BR_TIER + 1, Cont, (CogLevelQuest, Anywhere, 20, 9), Same, Same, NA, 5216, TTLocalizer.QuestDialogDict[5215]),
    ...
    5218: (BR_TIER + 1, Start, (CogQuest, Anywhere, 10, 'mh'), 3113, Same, NA, 5219, TTLocalizer.QuestDialogDict[5218]),
    5219: (BR_TIER + 1, Cont, (CogQuest, Anywhere, 20, 'ds'), Same, Same, NA, 5220, TTLocalizer.QuestDialogDict[5219]),
    5220: (BR_TIER + 1, Cont, (CogQuest, Anywhere, 15, 'ls'), Same, Same, NA, 5221, TTLocalizer.QuestDialogDict[5220]),
    5221: (BR_TIER + 1, Cont, (VisitQuest,), Same, 3211, NA, 5222, TTLocalizer.QuestDialogDict[5221]),
    5222: (BR_TIER + 1, Cont, (RecoverItemQuest, Anywhere, 1, 3007, Hard, AnyFish), Same, Same, NA, 5223, TTLocalizer.QuestDialogDict[5222]),
    5223: (BR_TIER + 1, Cont, (DeliverItemQuest, 3008), Same, 3113, NA, 5224, TTLocalizer.QuestDialogDict[5223]),
    5224: (BR_TIER + 1, Cont, (CogQuest, Anywhere, 1, 'bw'), Same, Same, 502, NA, TTLocalizer.QuestDialogDict[5224]),
    ...
    5229: (BR_TIER + 1, Cont, (CogTrackQuest, ToontownGlobals.TheBrrrgh, 15, 'm'), Same, Same, NA, 5230, TTLocalizer.QuestDialogDict[5229]),
    5267: (BR_TIER + 1, Cont, (CogTrackQuest, ToontownGlobals.TheBrrrgh, 15, 's'), Same, Same, NA, 5230, TTLocalizer.QuestDialogDict[5267]),
    5268: (BR_TIER + 1, Cont, (CogTrackQuest, ToontownGlobals.TheBrrrgh, 15, 'l'), Same, Same, NA, 5230, TTLocalizer.QuestDialogDict[5268]),
    5269: (BR_TIER + 1, Cont, (CogTrackQuest, ToontownGlobals.TheBrrrgh, 15, 'c'), Same, Same, NA, (5230, 5270, 5271, 5272), TTLocalizer.QuestDialogDict[5269]),
    ...
    5246: (BR_TIER + 1, Cont, (BuildingQuest, ToontownGlobals.TheBrrrgh, 20, Any, 1, 0), Same, Same, 101, NA, TTLocalizer.QuestDialogDict[5246]),
    5251: (BR_TIER + 1, Start, (VisitQuest,), Any, 3134, NA, 5252, TTLocalizer.QuestDialogDict[5251]),
    5252: (BR_TIER + 1, Start, (RecoverItemQuest, Anywhere, 3, 3019, VeryHard, Any), 3134, Same, NA, (5253, 5273, 5274, 5275), TTLocalizer.QuestDialogDict[5252]),
    5253: (BR_TIER + 1, Cont, (RecoverItemQuest, Anywhere, 2, 3020, VeryHard, 'cr'), Same, Same, NA, (5254, 5282, 5283, 5284), TTLocalizer.QuestDialogDict[5253]),
    5273: (BR_TIER + 1, Cont, (RecoverItemQuest, Anywhere, 2, 3020, VeryHard, 'm'), Same, Same, NA, (5254, 5282, 5283, 5284), TTLocalizer.QuestDialogDict[5273]),
    5274: (BR_TIER + 1, Cont, (RecoverItemQuest, Anywhere, 2, 3020, VeryHard, 'ls'), Same, Same, NA, (5254, 5282, 5283, 5284), TTLocalizer.QuestDialogDict[5274]),
    5275: (BR_TIER + 1, Cont, (RecoverItemQuest, Anywhere, 2, 3020, Hard, 'le'), Same, Same, NA, (5254, 5282, 5283, 5284), TTLocalizer.QuestDialogDict[5275]),
    ...
    5256: (BR_TIER + 1, Cont, (CogTrackQuest, Anywhere, 15, 'c'), 3228, Same, NA, (5257, 5277), TTLocalizer.QuestDialogDict[5256]),
    5276: (BR_TIER + 1, Cont, (CogTrackQuest, Anywhere, 15, 'l'), 3228, Same, NA, (5257, 5277), TTLocalizer.QuestDialogDict[5276]),
    5257: (BR_TIER + 1, Cont, (CogTrackQuest, Anywhere, 15, 's'), Same, Same, 100, NA, TTLocalizer.QuestDialogDict[5257]),
    5277: (BR_TIER + 1, Cont, (CogTrackQuest, Anywhere, 15, 'm'), Same, Same, 100, NA, TTLocalizer.QuestDialogDict[5277]),
    5301: (BR_TIER + 1, Start, (VisitQuest,), Any, 3304, NA, 5302, TTLocalizer.QuestDialogDict[5301]),
    5302: (BR_TIER + 1, Cont, (CogTrackQuest, Anywhere, 20, 's'), Same, Same, 100, NA, TTLocalizer.QuestDialogDict[5302]),
    5303: (BR_TIER + 1, Start, (VisitQuest,), Any, 3318, NA, 5304, TTLocalizer.QuestDialogDict[5303]),
    5304: (BR_TIER + 1, Cont, (RecoverItemQuest, ToontownGlobals.TheBrrrgh, 4, 3024, VeryHard, 'l', 'track'), Same, Same, NA, 5305, TTLocalizer.QuestDialogDict[5304]),
    ...
    5307: (BR_TIER + 1, Cont, (BuildingQuest, Anywhere, 1, Any, 5, 0), Same, Same, 204, NA, TTLocalizer.QuestDialogDict[5307]),
    5308: (BR_TIER + 1, Start, (VisitQuest,), Any, 3312, NA, 5309, TTLocalizer.QuestDialogDict[5308]),
    5309: (BR_TIER + 1, Start, (CogTrackQuest, ToontownGlobals.PolarPlace, 100, 'l'), Same, Same, NA, 5310, TTLocalizer.QuestDialogDict[5309]),
    5310: (BR_TIER + 1, Cont, (VisitQuest,), Same, 3113, NA, 5311, TTLocalizer.QuestDialogDict[5310]),
    5311: (BR_TIER + 1, Cont, (RecoverItemQuest, Anywhere, 1, 3026, Medium, 'bw'), Same, Same, NA, 5312, TTLocalizer.QuestDialogDict[5311]),
    5312: (BR_TIER + 1, Cont, (DeliverItemQuest, 3026), Same, 3312, 502, NA, TTLocalizer.QuestDialogDict[5312]),
    5500: (BR_TIER + 1, Start, (CogQuest, ToontownGlobals.TheBrrrgh, 100, Any), Any, ToonHQ, NA, 5501, DefaultDialog),
    ...
    5503: (BR_TIER + 1, Start, (RescueQuest, InFO, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    903: (BR_TIER + 2, Start, (VisitQuest,), Any, 3112, NA, (5234, 5278), TTLocalizer.QuestDialogDict[903]),
    5234: (BR_TIER + 2, Start, (RecoverItemQuest, Anywhere, 3, 3012, Medium, 'm'), 3112, Same, NA, (5235, 5279), TTLocalizer.QuestDialogDict[5234]),
    5278: (BR_TIER + 2, Start, (RecoverItemQuest, Anywhere, 3, 3022, Medium, 'le'), 3112, Same, NA, (5235, 5279), TTLocalizer.QuestDialogDict[5278]),
    5235: (BR_TIER + 2, Cont, (RecoverItemQuest, Anywhere, 2, 3013, Hard, 'mh'), Same, Same, NA, 5236, TTLocalizer.QuestDialogDict[5235]),
    5279: (BR_TIER + 2, Cont, (RecoverItemQuest, Anywhere, 5, 3013, Medium, 'tf'), Same, Same, NA, 5236, TTLocalizer.QuestDialogDict[5279]),
    ...
    5238: (BR_TIER + 2, Cont, (RecoverItemQuest, Anywhere, 6, 3015, VeryEasy, 'ms'), Same, Same, NA, 5239, TTLocalizer.QuestDialogDict[5238]),
    5280: (BR_TIER + 2, Cont, (RecoverItemQuest, Anywhere, 3, 3015, VeryEasy, 'sd'), Same, Same, NA, 5239, TTLocalizer.QuestDialogDict[5280]),
    5239: (BR_TIER + 2, Cont, (DeliverItemQuest, 3015), Same, 3112, NA, (5240, 5281), TTLocalizer.QuestDialogDict[5239]),
    5240: (BR_TIER + 2, Cont, (RecoverItemQuest, Anywhere, 2, 3016, Hard, 'm'), Same, Same, NA, 5241, TTLocalizer.QuestDialogDict[5240]),
    5281: (BR_TIER + 2, Cont, (RecoverItemQuest, Anywhere, 5, 3023, Hard, 'ds'), Same, Same, NA, 5241, TTLocalizer.QuestDialogDict[5281]),
    5241: (BR_TIER + 2, Cont, (BuildingQuest, Anywhere, 5, Any, 5, 0), Same, Same, NA, 5242, TTLocalizer.QuestDialogDict[5241]),
    5242: (BR_TIER + 2, Cont, (RecoverItemQuest, Anywhere, 1, 3014, VeryHard, AnyFish), Same, Same, 900, NA, TTLocalizer.QuestDialogDict[5242]),
    5320: (BR_TIER + 2, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5321: (BR_TIER + 2, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5322: (BR_TIER + 2, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5323: (BR_TIER + 2, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5324: (BR_TIER + 2, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5325: (BR_TIER + 2, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5326: (BR_TIER + 2, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5327: (BR_TIER + 2, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5328: (BR_TIER + 2, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5329: (BR_TIER + 2, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5330: (BR_TIER + 2, Start, (CogLevelQuest, Anywhere, 5, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    5331: (BR_TIER + 2, Start, (CogLevelQuest, Anywhere, 5, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    5332: (BR_TIER + 2, Start, (CogLevelQuest, Anywhere, 4, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    5333: (BR_TIER + 2, Start, (CogLevelQuest, Anywhere, 4, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    5334: (BR_TIER + 2, Start, (CogLevelQuest, Anywhere, 3, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5335: (BR_TIER + 2, Start, (CogLevelQuest, Anywhere, 3, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5336: (BR_TIER + 2, Start, (CogLevelQuest, Anywhere, 3, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5337: (BR_TIER + 2, Start, (CogLevelQuest, Anywhere, 2, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    5338: (BR_TIER + 2, Start, (CogLevelQuest, Anywhere, 2, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    5339: (BR_TIER + 2, Start, (CogLevelQuest, Anywhere, 2, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    5340: (BR_TIER + 2, Start, (CogQuest, ToontownGlobals.TheBrrrgh, 25, Any), Any, ToonHQ, NA, 5341, DefaultDialog),
    5341: (BR_TIER + 2, Cont, (DeliverItemQuest, 1000), Any, 3008, 1000, NA, DefaultDialog),
    5370: (BR_TIER + 2, Start, (CogQuest, ToontownGlobals.SellbotHQ, 100, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5371: (BR_TIER + 2, Start, (CogQuest, ToontownGlobals.SellbotHQ, 100, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    5372: (BR_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.SellbotHQ, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5373: (BR_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.SellbotHQ, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5374: (BR_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 1, 14), Any, ToonHQ, Any, NA, DefaultDialog),
    5375: (BR_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 1, 14), Any, ToonHQ, Any, NA, DefaultDialog),
    5376: (BR_TIER + 2, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5377: (BR_TIER + 2, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5378: (BR_TIER + 2, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5379: (BR_TIER + 2, Start, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5380: (BR_TIER + 2, Start, (SkelecogQuest, ToontownGlobals.SellbotFactoryInt, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5381: (BR_TIER + 2, Start, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5382: (BR_TIER + 2, Start, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    5383: (BR_TIER + 2, Start, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5384: (BR_TIER + 2, Start, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    5385: (BR_TIER + 2, Start, (RescueQuest, InVP, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    5386: (BR_TIER + 2, Start, (RescueQuest, InFO, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    6101: (DL_TIER, Start, (CogQuest, ToontownGlobals.DonaldsDreamland, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    6102: (DL_TIER, Start, (CogQuest, ToontownGlobals.DonaldsDreamland, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    6103: (DL_TIER, OBSOLETE, (CogQuest, ToontownGlobals.DonaldsDreamland, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    6104: (DL_TIER, Start, (CogQuest, Anywhere, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    6105: (DL_TIER, Start, (CogQuest, Anywhere, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    6106: (DL_TIER, Start, (CogQuest, Anywhere, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    6107: (DL_TIER, Start, (CogQuest, Anywhere, 7, 'ym'), Any, ToonHQ, Any, NA, DefaultDialog),
    6108: (DL_TIER, Start, (CogQuest, Anywhere, 6, 'mm'), Any, ToonHQ, Any, NA, DefaultDialog),
    6109: (DL_TIER, Start, (CogQuest, Anywhere, 5, 'ds'), Any, ToonHQ, Any, NA, DefaultDialog),
    6110: (DL_TIER, Start, (CogQuest, Anywhere, 4, 'hh'), Any, ToonHQ, Any, NA, DefaultDialog),
    6111: (DL_TIER, Start, (CogQuest, Anywhere, 3, 'cr'), Any, ToonHQ, Any, NA, DefaultDialog),
    6112: (DL_TIER, Start, (CogQuest, Anywhere, 2, 'tbc'), Any, ToonHQ, Any, NA, DefaultDialog),
    6113: (DL_TIER, Start, (CogQuest, Anywhere, 7, 'nd'), Any, ToonHQ, Any, NA, DefaultDialog),
    6114: (DL_TIER, Start, (CogQuest, Anywhere, 6, 'gh'), Any, ToonHQ, Any, NA, DefaultDialog),
    6115: (DL_TIER, Start, (CogQuest, Anywhere, 5, 'ms'), Any, ToonHQ, Any, NA, DefaultDialog),
    6116: (DL_TIER, Start, (CogQuest, Anywhere, 4, 'tf'), Any, ToonHQ, Any, NA, DefaultDialog),
    6117: (DL_TIER, Start, (CogQuest, Anywhere, 3, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    6118: (DL_TIER, Start, (CogQuest, Anywhere, 2, 'mh'), Any, ToonHQ, Any, NA, DefaultDialog),
    6119: (DL_TIER, Start, (CogQuest, Anywhere, 7, 'tw'), Any, ToonHQ, Any, NA, DefaultDialog),
    6120: (DL_TIER, Start, (CogQuest, Anywhere, 6, 'bc'), Any, ToonHQ, Any, NA, DefaultDialog),
    6121: (DL_TIER, Start, (CogQuest, Anywhere, 5, 'nc'), Any, ToonHQ, Any, NA, DefaultDialog),
    6122: (DL_TIER, OBSOLETE, (CogQuest, Anywhere, 4, 'mb'), Any, ToonHQ, Any, NA, DefaultDialog),
    6123: (DL_TIER, Start, (CogQuest, Anywhere, 3, 'ls'), Any, ToonHQ, Any, NA, DefaultDialog),
    6124: (DL_TIER, Start, (CogQuest, Anywhere, 2, 'rb'), Any, ToonHQ, Any, NA, DefaultDialog),
    6125: (DL_TIER, Start, (CogQuest, Anywhere, 7, 'dt'), Any, ToonHQ, Any, NA, DefaultDialog),
    6126: (DL_TIER, Start, (CogQuest, Anywhere, 6, 'ac'), Any, ToonHQ, Any, NA, DefaultDialog),
    6127: (DL_TIER, Start, (CogQuest, Anywhere, 5, 'bs'), Any, ToonHQ, Any, NA, DefaultDialog),
    6128: (DL_TIER, Start, (CogQuest, Anywhere, 4, 'sd'), Any, ToonHQ, Any, NA, DefaultDialog),
    6129: (DL_TIER, Start, (CogQuest, Anywhere, 3, 'le'), Any, ToonHQ, Any, NA, DefaultDialog),
    6130: (DL_TIER, Start, (CogQuest, Anywhere, 2, 'bw'), Any, ToonHQ, Any, NA, DefaultDialog),
    6131: (DL_TIER, Start, (CogLevelQuest, Anywhere, 4, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    6132: (DL_TIER, Start, (CogLevelQuest, Anywhere, 4, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    6133: (DL_TIER, Start, (CogLevelQuest, Anywhere, 3, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    6134: (DL_TIER, Start, (CogLevelQuest, Anywhere, 3, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    6135: (DL_TIER, Start, (CogLevelQuest, Anywhere, 2, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    6136: (DL_TIER, Start, (CogLevelQuest, Anywhere, 2, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    6137: (DL_TIER, Start, (CogLevelQuest, Anywhere, 1, 10), Any, ToonHQ, Any, NA, DefaultDialog),
    6138: (DL_TIER, Start, (CogLevelQuest, Anywhere, 1, 10), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    6143: (DL_TIER, OBSOLETE, (CogTrackQuest, ToontownGlobals.DonaldsDreamland, 30, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    6144: (DL_TIER, Start, (CogTrackQuest, ToontownGlobals.DonaldsDreamland, 30, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    6145: (DL_TIER, Start, (CogTrackQuest, ToontownGlobals.DonaldsDreamland, 30, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    6146: (DL_TIER, Start, (CogTrackQuest, ToontownGlobals.DonaldsDreamland, 30, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    6147: (DL_TIER, OBSOLETE, (CogTrackQuest, Anywhere, 20, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    6148: (DL_TIER, Start, (CogTrackQuest, Anywhere, 20, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    6149: (DL_TIER, Start, (CogTrackQuest, Anywhere, 20, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    6150: (DL_TIER, Start, (CogTrackQuest, Anywhere, 20, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    6151: (DL_TIER, Start, (BuildingQuest, Anywhere, 1, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6152: (DL_TIER, Start, (BuildingQuest, Anywhere, 2, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6153: (DL_TIER, OBSOLETE, (BuildingQuest, Anywhere, 3, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6154: (DL_TIER, Start, (BuildingQuest, Anywhere, 4, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    6170: (DL_TIER, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    6171: (DL_TIER, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    6172: (DL_TIER, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    6173: (DL_TIER, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotHQ, 15, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    6174: (DL_TIER, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotHQ, 10, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    6175: (DL_TIER, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotHQ, 3, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    6176: (DL_TIER, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 1, 14), Any, ToonHQ, Any, NA, DefaultDialog),
    6177: (DL_TIER, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 1, 14), Any, ToonHQ, Any, NA, DefaultDialog),
    6178: (DL_TIER, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 1, 14), Any, ToonHQ, Any, NA, DefaultDialog),
    6179: (DL_TIER, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6180: (DL_TIER, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6181: (DL_TIER, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6182: (DL_TIER, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6183: (DL_TIER, OBSOLETE, (SkelecogQuest, ToontownGlobals.SellbotFactoryInt, 20), Any, ToonHQ, Any, NA, DefaultDialog),
    6184: (DL_TIER, OBSOLETE, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 2, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    6185: (DL_TIER, OBSOLETE, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    6186: (DL_TIER, OBSOLETE, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6187: (DL_TIER, OBSOLETE, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6197: (DL_TIER, Start, (BuildingQuest, Anywhere, 5, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6198: (DL_TIER, Start, (BuildingQuest, Anywhere, 5, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6199: (DL_TIER, Start, (BuildingQuest, Anywhere, 3, 's', 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6200: (DL_TIER, Start, (BuildingQuest, Anywhere, 3, 'l', 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6201: (DL_TIER, Start, (VisitQuest,), Any, 9111, NA, 6202, TTLocalizer.QuestDialogDict[6201]),
    6202: (DL_TIER, Start, (CogQuest, ToontownGlobals.DonaldsDreamland, 10, Any), 9111, Same, 100, NA, TTLocalizer.QuestDialogDict[6202]),
    6206: (DL_TIER, Start, (VisitQuest,), Any, 9131, NA, 6207, TTLocalizer.QuestDialogDict[6206]),
    6207: (DL_TIER, Start, (BuildingQuest, ToontownGlobals.DonaldsDreamland, 1, Any, 5, 0), 9131, Same, 205, NA, TTLocalizer.QuestDialogDict[6207]),
    6211: (DL_TIER, Start, (VisitQuest,), Any, 9217, NA, 6212, TTLocalizer.QuestDialogDict[6211]),
    6212: (DL_TIER, Start, (RecoverItemQuest, Anywhere, 1, 6002, Medium, 'rb'), 9217, Same, NA, 6213, TTLocalizer.QuestDialogDict[6212]),
    6213: (DL_TIER, Cont, (RecoverItemQuest, Anywhere, 2, 6003, Hard, 'mh'), Same, Same, NA, 6214, TTLocalizer.QuestDialogDict[6213]),
    6214: (DL_TIER, Cont, (RecoverItemQuest, Anywhere, 3, 6004, VeryHard, 'tbc'), Same, Same, 101, NA, TTLocalizer.QuestDialogDict[6214]),
    6221: (DL_TIER, Start, (VisitQuest,), Any, 9119, NA, 6222, TTLocalizer.QuestDialogDict[6221]),
    6222: (DL_TIER, Start, (CogTrackQuest, ToontownGlobals.DonaldsDreamland, 15, 'c'), 9119, Same, 102, NA, TTLocalizer.QuestDialogDict[6222]),
    ...
    6233: (DL_TIER, Cont, (CogTrackQuest, ToontownGlobals.CashbotHQ, 5, 'm'), Same, Same, NA, 6234, TTLocalizer.QuestDialogDict[6233]),
    ...
    6242: (DL_TIER, Start, (CogQuest, ToontownGlobals.DonaldsDreamland, 5, 'mb'), 9219, Same, 705, NA, TTLocalizer.QuestDialogDict[6242]),
    ...
    6255: (DL_TIER, Cont, (CogTrackQuest, Anywhere, 20, 'm'), Same, Same, NA, 6256, TTLocalizer.QuestDialogDict[6255]),
    ...
    6258: (DL_TIER, Cont, (CogQuest, Anywhere, 3, 'mh'), Same, Same, NA, 6259, TTLocalizer.QuestDialogDict[6258]),
    ...
    6282: (DL_TIER, Start, (CogTrackQuest, ToontownGlobals.DonaldsDreamland, 20, 'm'), 9123, Same, 4001, NA, TTLocalizer.QuestDialogDict[6282]),
    ...
    6301: (DL_TIER, Start, (CogQuest, ToontownGlobals.CashbotHQ, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    6302: (DL_TIER, Start, (CogQuest, ToontownGlobals.CashbotHQ, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    6303: (DL_TIER, Start, (CogQuest, ToontownGlobals.CashbotHQ, 15, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    6304: (DL_TIER, Start, (CogLevelQuest, ToontownGlobals.CashbotHQ, 15, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    6305: (DL_TIER, Start, (CogLevelQuest, ToontownGlobals.CashbotHQ, 10, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    6306: (DL_TIER, Start, (CogLevelQuest, ToontownGlobals.CashbotHQ, 5, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    6307: (DL_TIER, Start, (CogLevelQuest, ToontownGlobals.CashbotMintIntA, 16, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    6308: (DL_TIER, OBSOLETE, (CogLevelQuest, ToontownGlobals.CashbotMintIntB, 24, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    6309: (DL_TIER, OBSOLETE, (CogLevelQuest, ToontownGlobals.CashbotMintIntC, 36, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    6310: (DL_TIER, Start, (MintQuest, ToontownGlobals.CashbotMintIntA, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6311: (DL_TIER, OBSOLETE, (MintQuest, ToontownGlobals.CashbotMintIntB, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6312: (DL_TIER, OBSOLETE, (MintQuest, ToontownGlobals.CashbotMintIntC, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6313: (DL_TIER, Start, (SkelecogQuest, ToontownGlobals.CashbotHQ, 10), Any, ToonHQ, Any, NA, DefaultDialog),
    6314: (DL_TIER, Start, (SkelecogLevelQuest, ToontownGlobals.CashbotHQ, 4, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    6315: (DL_TIER, Start, (SkelecogLevelQuest, ToontownGlobals.CashbotHQ, 2, 10), Any, ToonHQ, Any, NA, DefaultDialog),
    6318: (DL_TIER, Start, (SupervisorQuest, ToontownGlobals.CashbotMintIntA, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6319: (DL_TIER, OBSOLETE, (SupervisorQuest, ToontownGlobals.CashbotMintIntB, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6320: (DL_TIER, OBSOLETE, (SupervisorQuest, ToontownGlobals.CashbotMintIntC, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6321: (DL_TIER, Start, (CogLevelQuest, ToontownGlobals.CashbotMintIntA, 12, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    6322: (DL_TIER, Start, (CogLevelQuest, ToontownGlobals.CashbotMintIntA, 12, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    6323: (DL_TIER, Start, (MintQuest, ToontownGlobals.CashbotMintIntA, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6324: (DL_TIER, Start, (MintQuest, ToontownGlobals.CashbotMintIntA, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6325: (DL_TIER, Start, (SupervisorQuest, ToontownGlobals.CashbotMintIntA, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6326: (DL_TIER, Start, (SupervisorQuest, ToontownGlobals.CashbotMintIntA, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    6327: (DL_TIER, Start, (RescueQuest, InVP, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    6328: (DL_TIER, Start, (RescueQuest, InFO, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    7101: (DL_TIER + 1, Start, (CogQuest, Anywhere, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    7102: (DL_TIER + 1, Start, (CogQuest, Anywhere, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    7103: (DL_TIER + 1, OBSOLETE, (CogQuest, Anywhere, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    7104: (DL_TIER + 1, Start, (CogQuest, Anywhere, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    7105: (DL_TIER + 1, Start, (CogQuest, Anywhere, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    7106: (DL_TIER + 1, Start, (CogQuest, Anywhere, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    7107: (DL_TIER + 1, Start, (CogQuest, Anywhere, 7, 'ym'), Any, ToonHQ, Any, NA, DefaultDialog),
    7108: (DL_TIER + 1, Start, (CogQuest, Anywhere, 6, 'mm'), Any, ToonHQ, Any, NA, DefaultDialog),
    7109: (DL_TIER + 1, Start, (CogQuest, Anywhere, 5, 'ds'), Any, ToonHQ, Any, NA, DefaultDialog),
    7110: (DL_TIER + 1, Start, (CogQuest, Anywhere, 4, 'hh'), Any, ToonHQ, Any, NA, DefaultDialog),
    7111: (DL_TIER + 1, Start, (CogQuest, Anywhere, 3, 'cr'), Any, ToonHQ, Any, NA, DefaultDialog),
    7112: (DL_TIER + 1, Start, (CogQuest, Anywhere, 2, 'tbc'), Any, ToonHQ, Any, NA, DefaultDialog),
    7113: (DL_TIER + 1, Start, (CogQuest, Anywhere, 7, 'nd'), Any, ToonHQ, Any, NA, DefaultDialog),
    7114: (DL_TIER + 1, Start, (CogQuest, Anywhere, 6, 'gh'), Any, ToonHQ, Any, NA, DefaultDialog),
    7115: (DL_TIER + 1, Start, (CogQuest, Anywhere, 5, 'ms'), Any, ToonHQ, Any, NA, DefaultDialog),
    7116: (DL_TIER + 1, Start, (CogQuest, Anywhere, 4, 'tf'), Any, ToonHQ, Any, NA, DefaultDialog),
    7117: (DL_TIER + 1, Start, (CogQuest, Anywhere, 3, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    7118: (DL_TIER + 1, Start, (CogQuest, Anywhere, 2, 'mh'), Any, ToonHQ, Any, NA, DefaultDialog),
    7119: (DL_TIER + 1, Start, (CogQuest, Anywhere, 7, 'tw'), Any, ToonHQ, Any, NA, DefaultDialog),
    7120: (DL_TIER + 1, Start, (CogQuest, Anywhere, 6, 'bc'), Any, ToonHQ, Any, NA, DefaultDialog),
    7121: (DL_TIER + 1, OBSOLETE, (CogQuest, Anywhere, 5, 'nc'), Any, ToonHQ, Any, NA, DefaultDialog),
    7122: (DL_TIER + 1, Start, (CogQuest, Anywhere, 4, 'mb'), Any, ToonHQ, Any, NA, DefaultDialog),
    7123: (DL_TIER + 1, Start, (CogQuest, Anywhere, 3, 'ls'), Any, ToonHQ, Any, NA, DefaultDialog),
    7124: (DL_TIER + 1, Start, (CogQuest, Anywhere, 2, 'rb'), Any, ToonHQ, Any, NA, DefaultDialog),
    7125: (DL_TIER + 1, Start, (CogQuest, Anywhere, 7, 'dt'), Any, ToonHQ, Any, NA, DefaultDialog),
    7126: (DL_TIER + 1, Start, (CogQuest, Anywhere, 6, 'ac'), Any, ToonHQ, Any, NA, DefaultDialog),
    7127: (DL_TIER + 1, Start, (CogQuest, Anywhere, 5, 'bs'), Any, ToonHQ, Any, NA, DefaultDialog),
    7128: (DL_TIER + 1, Start, (CogQuest, Anywhere, 4, 'sd'), Any, ToonHQ, Any, NA, DefaultDialog),
    7129: (DL_TIER + 1, Start, (CogQuest, Anywhere, 3, 'le'), Any, ToonHQ, Any, NA, DefaultDialog),
    7130: (DL_TIER + 1, Start, (CogQuest, Anywhere, 2, 'bw'), Any, ToonHQ, Any, NA, DefaultDialog),
    7131: (DL_TIER + 1, Start, (CogLevelQuest, Anywhere, 6, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    7132: (DL_TIER + 1, Start, (CogLevelQuest, Anywhere, 5, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    7133: (DL_TIER + 1, Start, (CogLevelQuest, Anywhere, 5, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    7134: (DL_TIER + 1, Start, (CogLevelQuest, Anywhere, 4, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    7135: (DL_TIER + 1, Start, (CogLevelQuest, Anywhere, 3, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    7136: (DL_TIER + 1, Start, (CogLevelQuest, Anywhere, 3, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    7137: (DL_TIER + 1, Start, (CogLevelQuest, Anywhere, 2, 10), Any, ToonHQ, Any, NA, DefaultDialog),
    7138: (DL_TIER + 1, Start, (CogLevelQuest, Anywhere, 1, 10), Any, ToonHQ, Any, NA, DefaultDialog),
    7139: (DL_TIER + 1, Start, (CogTrackQuest, Anywhere, 30, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    7140: (DL_TIER + 1, Start, (CogTrackQuest, Anywhere, 30, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    7141: (DL_TIER + 1, Start, (CogTrackQuest, Anywhere, 30, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    7142: (DL_TIER + 1, Start, (CogTrackQuest, Anywhere, 30, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    7143: (DL_TIER + 1, OBSOLETE, (CogTrackQuest, Anywhere, 25, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    7144: (DL_TIER + 1, Start, (CogTrackQuest, Anywhere, 25, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    7145: (DL_TIER + 1, Start, (CogTrackQuest, Anywhere, 25, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    7146: (DL_TIER + 1, Start, (CogTrackQuest, Anywhere, 25, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    7147: (DL_TIER + 1, Start, (CogTrackQuest, Anywhere, 25, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    7148: (DL_TIER + 1, Start, (CogTrackQuest, Anywhere, 25, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    7149: (DL_TIER + 1, Start, (CogTrackQuest, Anywhere, 25, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    7150: (DL_TIER + 1, Start, (CogTrackQuest, Anywhere, 25, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    7151: (DL_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    7152: (DL_TIER + 1, OBSOLETE, (BuildingQuest, Anywhere, 1, Any, 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    7153: (DL_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    7154: (DL_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    7155: (DL_TIER + 1, OBSOLETE, (BuildingQuest, Anywhere, 1, 'm', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    7156: (DL_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 's', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    7157: (DL_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'c', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    7158: (DL_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'l', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    7170: (DL_TIER + 1, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    7171: (DL_TIER + 1, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    7172: (DL_TIER + 1, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    7173: (DL_TIER + 1, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotHQ, 6, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    7174: (DL_TIER + 1, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotHQ, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    7175: (DL_TIER + 1, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotHQ, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    7176: (DL_TIER + 1, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 4, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    7177: (DL_TIER + 1, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 3, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    7178: (DL_TIER + 1, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    7179: (DL_TIER + 1, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7180: (DL_TIER + 1, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7181: (DL_TIER + 1, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7182: (DL_TIER + 1, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7183: (DL_TIER + 1, OBSOLETE, (SkelecogQuest, ToontownGlobals.SellbotFactoryInt, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    7184: (DL_TIER + 1, OBSOLETE, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    7185: (DL_TIER + 1, OBSOLETE, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    7186: (DL_TIER + 1, OBSOLETE, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7187: (DL_TIER + 1, OBSOLETE, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    7211: (DL_TIER + 1, Cont, (CogQuest, Anywhere, 1, 'rb'), Same, Same, NA, 7212, TTLocalizer.QuestDialogDict[7211]),
    ...
    7214: (DL_TIER + 1, Cont, (CogTrackQuest, Anywhere, 10, 'm'), Same, Same, NA, 7215, TTLocalizer.QuestDialogDict[7214]),
    ...
    7222: (DL_TIER + 1, Cont, (BuildingQuest, Anywhere, 1, Any, 4, 0), Same, Same, NA, 7223, TTLocalizer.QuestDialogDict[7222]),
    ...
    7250: (DL_TIER + 1, Start, (CogQuest, ToontownGlobals.CashbotHQ, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    7251: (DL_TIER + 1, Start, (CogQuest, ToontownGlobals.CashbotHQ, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    7252: (DL_TIER + 1, Start, (CogQuest, ToontownGlobals.CashbotHQ, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    7253: (DL_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.CashbotHQ, 16, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    7254: (DL_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.CashbotHQ, 12, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    7255: (DL_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.CashbotHQ, 4, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    7256: (DL_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.CashbotMintIntA, 16, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    7257: (DL_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.CashbotMintIntB, 24, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    7258: (DL_TIER + 1, OBSOLETE, (CogLevelQuest, ToontownGlobals.CashbotMintIntC, 36, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    7259: (DL_TIER + 1, Start, (MintQuest, ToontownGlobals.CashbotMintIntA, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7260: (DL_TIER + 1, Start, (MintQuest, ToontownGlobals.CashbotMintIntB, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7261: (DL_TIER + 1, OBSOLETE, (MintQuest, ToontownGlobals.CashbotMintIntC, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7262: (DL_TIER + 1, Start, (SkelecogQuest, ToontownGlobals.CashbotHQ, 20), Any, ToonHQ, Any, NA, DefaultDialog),
    7263: (DL_TIER + 1, Start, (SkelecogLevelQuest, ToontownGlobals.CashbotHQ, 4, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    7264: (DL_TIER + 1, Start, (SkelecogLevelQuest, ToontownGlobals.CashbotHQ, 4, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    7265: (DL_TIER + 1, Start, (SupervisorQuest, ToontownGlobals.CashbotMintIntA, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7266: (DL_TIER + 1, Start, (SupervisorQuest, ToontownGlobals.CashbotMintIntB, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7267: (DL_TIER + 1, OBSOLETE, (SupervisorQuest, ToontownGlobals.CashbotMintIntC, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7268: (DL_TIER + 1, Start, (CogLevelQuest, ToontownGlobals.CashbotMintIntB, 24, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    7269: (DL_TIER + 1, Start, (MintQuest, ToontownGlobals.CashbotMintIntB, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7270: (DL_TIER + 1, Start, (SupervisorQuest, ToontownGlobals.CashbotMintIntB, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7500: (DL_TIER + 1, Start, (CogQuest, ToontownGlobals.DonaldsDreamland, 25, Any), Any, ToonHQ, NA, 7501, DefaultDialog),
    7501: (DL_TIER + 1, Cont, (DeliverItemQuest, 1000), Any, 9010, 1000, NA, DefaultDialog),
    7502: (DL_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7503: (DL_TIER + 1, Start, (BuildingQuest, Anywhere, 1, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7504: (DL_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 's', 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7505: (DL_TIER + 1, Start, (BuildingQuest, Anywhere, 1, 'l', 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    7506: (DL_TIER + 1, Start, (RescueQuest, InVP, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    7507: (DL_TIER + 1, Start, (RescueQuest, InFO, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    8101: (DL_TIER + 2, Start, (CogQuest, Anywhere, 30, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    8102: (DL_TIER + 2, Start, (CogQuest, Anywhere, 30, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    8103: (DL_TIER + 2, Start, (CogQuest, Anywhere, 30, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    8104: (DL_TIER + 2, Start, (CogQuest, Anywhere, 30, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    8105: (DL_TIER + 2, Start, (CogQuest, Anywhere, 30, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    8106: (DL_TIER + 2, Start, (CogQuest, Anywhere, 30, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    8107: (DL_TIER + 2, Start, (CogQuest, Anywhere, 9, 'ym'), Any, ToonHQ, Any, NA, DefaultDialog),
    8108: (DL_TIER + 2, Start, (CogQuest, Anywhere, 8, 'mm'), Any, ToonHQ, Any, NA, DefaultDialog),
    8109: (DL_TIER + 2, Start, (CogQuest, Anywhere, 7, 'ds'), Any, ToonHQ, Any, NA, DefaultDialog),
    8110: (DL_TIER + 2, Start, (CogQuest, Anywhere, 6, 'hh'), Any, ToonHQ, Any, NA, DefaultDialog),
    8111: (DL_TIER + 2, Start, (CogQuest, Anywhere, 5, 'cr'), Any, ToonHQ, Any, NA, DefaultDialog),
    8112: (DL_TIER + 2, Start, (CogQuest, Anywhere, 4, 'tbc'), Any, ToonHQ, Any, NA, DefaultDialog),
    8113: (DL_TIER + 2, Start, (CogQuest, Anywhere, 9, 'nd'), Any, ToonHQ, Any, NA, DefaultDialog),
    8114: (DL_TIER + 2, Start, (CogQuest, Anywhere, 8, 'gh'), Any, ToonHQ, Any, NA, DefaultDialog),
    8115: (DL_TIER + 2, Start, (CogQuest, Anywhere, 7, 'ms'), Any, ToonHQ, Any, NA, DefaultDialog),
    8116: (DL_TIER + 2, Start, (CogQuest, Anywhere, 6, 'tf'), Any, ToonHQ, Any, NA, DefaultDialog),
    8117: (DL_TIER + 2, Start, (CogQuest, Anywhere, 5, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    8118: (DL_TIER + 2, Start, (CogQuest, Anywhere, 4, 'mh'), Any, ToonHQ, Any, NA, DefaultDialog),
    8119: (DL_TIER + 2, Start, (CogQuest, Anywhere, 9, 'tw'), Any, ToonHQ, Any, NA, DefaultDialog),
    8120: (DL_TIER + 2, Start, (CogQuest, Anywhere, 8, 'bc'), Any, ToonHQ, Any, NA, DefaultDialog),
    8121: (DL_TIER + 2, Start, (CogQuest, Anywhere, 7, 'nc'), Any, ToonHQ, Any, NA, DefaultDialog),
    8122: (DL_TIER + 2, Start, (CogQuest, Anywhere, 6, 'mb'), Any, ToonHQ, Any, NA, DefaultDialog),
    8123: (DL_TIER + 2, Start, (CogQuest, Anywhere, 5, 'ls'), Any, ToonHQ, Any, NA, DefaultDialog),
    8124: (DL_TIER + 2, Start, (CogQuest, Anywhere, 4, 'rb'), Any, ToonHQ, Any, NA, DefaultDialog),
    8125: (DL_TIER + 2, Start, (CogQuest, Anywhere, 9, 'dt'), Any, ToonHQ, Any, NA, DefaultDialog),
    8126: (DL_TIER + 2, Start, (CogQuest, Anywhere, 8, 'ac'), Any, ToonHQ, Any, NA, DefaultDialog),
    8127: (DL_TIER + 2, Start, (CogQuest, Anywhere, 7, 'bs'), Any, ToonHQ, Any, NA, DefaultDialog),
    8128: (DL_TIER + 2, Start, (CogQuest, Anywhere, 6, 'sd'), Any, ToonHQ, Any, NA, DefaultDialog),
    8129: (DL_TIER + 2, Start, (CogQuest, Anywhere, 5, 'le'), Any, ToonHQ, Any, NA, DefaultDialog),
    8130: (DL_TIER + 2, Start, (CogQuest, Anywhere, 4, 'bw'), Any, ToonHQ, Any, NA, DefaultDialog),
    8131: (DL_TIER + 2, Start, (CogLevelQuest, Anywhere, 9, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    8132: (DL_TIER + 2, Start, (CogLevelQuest, Anywhere, 8, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    8133: (DL_TIER + 2, Start, (CogLevelQuest, Anywhere, 7, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    8134: (DL_TIER + 2, Start, (CogLevelQuest, Anywhere, 6, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    8135: (DL_TIER + 2, Start, (CogLevelQuest, Anywhere, 5, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    8136: (DL_TIER + 2, Start, (CogLevelQuest, Anywhere, 4, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    8137: (DL_TIER + 2, Start, (CogLevelQuest, Anywhere, 3, 10), Any, ToonHQ, Any, NA, DefaultDialog),
    8138: (DL_TIER + 2, Start, (CogLevelQuest, Anywhere, 2, 10), Any, ToonHQ, Any, NA, DefaultDialog),
    8139: (DL_TIER + 2, Start, (CogTrackQuest, Anywhere, 35, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    8140: (DL_TIER + 2, Start, (CogTrackQuest, Anywhere, 35, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    8141: (DL_TIER + 2, Start, (CogTrackQuest, Anywhere, 35, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    8142: (DL_TIER + 2, Start, (CogTrackQuest, Anywhere, 35, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    8143: (DL_TIER + 2, Start, (CogTrackQuest, Anywhere, 35, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    8144: (DL_TIER + 2, Start, (CogTrackQuest, Anywhere, 30, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    8145: (DL_TIER + 2, Start, (CogTrackQuest, Anywhere, 30, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    8146: (DL_TIER + 2, Start, (CogTrackQuest, Anywhere, 30, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    8147: (DL_TIER + 2, Start, (CogTrackQuest, Anywhere, 30, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    8148: (DL_TIER + 2, Start, (CogTrackQuest, Anywhere, 30, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    8149: (DL_TIER + 2, Start, (CogTrackQuest, Anywhere, 30, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    8150: (DL_TIER + 2, Start, (CogTrackQuest, Anywhere, 30, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    8151: (DL_TIER + 2, Start, (BuildingQuest, Anywhere, 4, Any, 2, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    8152: (DL_TIER + 2, Start, (BuildingQuest, Anywhere, 3, Any, 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    8153: (DL_TIER + 2, Start, (BuildingQuest, Anywhere, 2, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    8154: (DL_TIER + 2, Start, (BuildingQuest, Anywhere, 1, Any, 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    8155: (DL_TIER + 2, Start, (BuildingQuest, Anywhere, 1, 'm', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    8156: (DL_TIER + 2, Start, (BuildingQuest, Anywhere, 1, 's', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    8157: (DL_TIER + 2, Start, (BuildingQuest, Anywhere, 1, 'c', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    8158: (DL_TIER + 2, Start, (BuildingQuest, Anywhere, 1, 'l', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    8170: (DL_TIER + 2, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    8171: (DL_TIER + 2, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 30, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    8172: (DL_TIER + 2, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 40, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    8173: (DL_TIER + 2, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotHQ, 24, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    8174: (DL_TIER + 2, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotHQ, 20, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    8175: (DL_TIER + 2, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotHQ, 15, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    8176: (DL_TIER + 2, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    8177: (DL_TIER + 2, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 3, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    8178: (DL_TIER + 2, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 1, 14), Any, ToonHQ, Any, NA, DefaultDialog),
    8179: (DL_TIER + 2, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8180: (DL_TIER + 2, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8181: (DL_TIER + 2, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8182: (DL_TIER + 2, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8183: (DL_TIER + 2, OBSOLETE, (SkelecogQuest, ToontownGlobals.SellbotFactoryInt, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    8184: (DL_TIER + 2, OBSOLETE, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 3, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    8185: (DL_TIER + 2, OBSOLETE, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 1, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    8186: (DL_TIER + 2, OBSOLETE, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8187: (DL_TIER + 2, OBSOLETE, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8188: (DL_TIER + 2, Start, (BossQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8189: (DL_TIER + 2, Start, (RescueQuest, InVP, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    8197: (DL_TIER + 2, Start, (RescueQuest, InFO, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    8201: (DL_TIER + 2, Start, (CogQuest, ToontownGlobals.CashbotHQ, 30, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    8202: (DL_TIER + 2, Start, (CogQuest, ToontownGlobals.CashbotHQ, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    8203: (DL_TIER + 2, Start, (CogQuest, ToontownGlobals.CashbotHQ, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    8204: (DL_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.CashbotHQ, 1, 15), Any, ToonHQ, Any, NA, DefaultDialog),
    8205: (DL_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.CashbotHQ, 16, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    8206: (DL_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.CashbotHQ, 4, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    8207: (DL_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.CashbotMintIntA, 4, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    8208: (DL_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.CashbotMintIntB, 6, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    8209: (DL_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.CashbotMintIntC, 10, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    8210: (DL_TIER + 2, Start, (MintQuest, ToontownGlobals.CashbotMintIntA, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8211: (DL_TIER + 2, Start, (MintQuest, ToontownGlobals.CashbotMintIntB, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8212: (DL_TIER + 2, Start, (MintQuest, ToontownGlobals.CashbotMintIntC, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8213: (DL_TIER + 2, Start, (SkelecogQuest, ToontownGlobals.CashbotMintIntA, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    8214: (DL_TIER + 2, Start, (SkelecogQuest, ToontownGlobals.CashbotMintIntB, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    8215: (DL_TIER + 2, Start, (SkelecogQuest, ToontownGlobals.CashbotMintIntC, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    8216: (DL_TIER + 2, Start, (SupervisorQuest, ToontownGlobals.CashbotMintIntA, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8217: (DL_TIER + 2, Start, (SupervisorQuest, ToontownGlobals.CashbotMintIntB, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8218: (DL_TIER + 2, Start, (SupervisorQuest, ToontownGlobals.CashbotMintIntC, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8219: (DL_TIER + 2, Start, (BossQuest, ToontownGlobals.CashbotHQ, 1), Any, ToonHQ, 621, NA, DefaultDialog),
    8220: (DL_TIER + 2, Start, (BuildingQuest, Anywhere, 3, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8221: (DL_TIER + 2, Start, (BuildingQuest, Anywhere, 3, Any, 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8224: (DL_TIER + 2, Start, (BuildingQuest, Anywhere, 2, 's', 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8225: (DL_TIER + 2, Start, (BuildingQuest, Anywhere, 2, 'l', 0, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    8226: (DL_TIER + 2, Start, (RescueQuest, InFO, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    9101: (DL_TIER + 3, Start, (CogQuest, Anywhere, 40, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    9102: (DL_TIER + 3, Start, (CogQuest, Anywhere, 40, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    9103: (DL_TIER + 3, Start, (CogQuest, Anywhere, 40, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    9104: (DL_TIER + 3, Start, (CogQuest, Anywhere, 40, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    9105: (DL_TIER + 3, Start, (CogQuest, Anywhere, 40, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    9106: (DL_TIER + 3, Start, (CogQuest, Anywhere, 40, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    9107: (DL_TIER + 3, Start, (CogQuest, Anywhere, 10, 'ym'), Any, ToonHQ, Any, NA, DefaultDialog),
    9108: (DL_TIER + 3, Start, (CogQuest, Anywhere, 9, 'mm'), Any, ToonHQ, Any, NA, DefaultDialog),
    9109: (DL_TIER + 3, Start, (CogQuest, Anywhere, 8, 'ds'), Any, ToonHQ, Any, NA, DefaultDialog),
    9110: (DL_TIER + 3, Start, (CogQuest, Anywhere, 7, 'hh'), Any, ToonHQ, Any, NA, DefaultDialog),
    9111: (DL_TIER + 3, Start, (CogQuest, Anywhere, 6, 'cr'), Any, ToonHQ, Any, NA, DefaultDialog),
    9112: (DL_TIER + 3, Start, (CogQuest, Anywhere, 5, 'tbc'), Any, ToonHQ, Any, NA, DefaultDialog),
    9113: (DL_TIER + 3, Start, (CogQuest, Anywhere, 10, 'nd'), Any, ToonHQ, Any, NA, DefaultDialog),
    9114: (DL_TIER + 3, Start, (CogQuest, Anywhere, 9, 'gh'), Any, ToonHQ, Any, NA, DefaultDialog),
    9115: (DL_TIER + 3, Start, (CogQuest, Anywhere, 8, 'ms'), Any, ToonHQ, Any, NA, DefaultDialog),
    9116: (DL_TIER + 3, Start, (CogQuest, Anywhere, 7, 'tf'), Any, ToonHQ, Any, NA, DefaultDialog),
    9117: (DL_TIER + 3, Start, (CogQuest, Anywhere, 6, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    9118: (DL_TIER + 3, Start, (CogQuest, Anywhere, 5, 'mh'), Any, ToonHQ, Any, NA, DefaultDialog),
    9119: (DL_TIER + 3, Start, (CogQuest, Anywhere, 10, 'tw'), Any, ToonHQ, Any, NA, DefaultDialog),
    9120: (DL_TIER + 3, Start, (CogQuest, Anywhere, 9, 'bc'), Any, ToonHQ, Any, NA, DefaultDialog),
    9121: (DL_TIER + 3, Start, (CogQuest, Anywhere, 8, 'nc'), Any, ToonHQ, Any, NA, DefaultDialog),
    9122: (DL_TIER + 3, Start, (CogQuest, Anywhere, 7, 'mb'), Any, ToonHQ, Any, NA, DefaultDialog),
    9123: (DL_TIER + 3, Start, (CogQuest, Anywhere, 6, 'ls'), Any, ToonHQ, Any, NA, DefaultDialog),
    9124: (DL_TIER + 3, Start, (CogQuest, Anywhere, 5, 'rb'), Any, ToonHQ, Any, NA, DefaultDialog),
    9125: (DL_TIER + 3, Start, (CogQuest, Anywhere, 10, 'dt'), Any, ToonHQ, Any, NA, DefaultDialog),
    9126: (DL_TIER + 3, Start, (CogQuest, Anywhere, 9, 'ac'), Any, ToonHQ, Any, NA, DefaultDialog),
    9127: (DL_TIER + 3, Start, (CogQuest, Anywhere, 8, 'bs'), Any, ToonHQ, Any, NA, DefaultDialog),
    9128: (DL_TIER + 3, Start, (CogQuest, Anywhere, 7, 'sd'), Any, ToonHQ, Any, NA, DefaultDialog),
    9129: (DL_TIER + 3, Start, (CogQuest, Anywhere, 6, 'le'), Any, ToonHQ, Any, NA, DefaultDialog),
    9130: (DL_TIER + 3, Start, (CogQuest, Anywhere, 5, 'bw'), Any, ToonHQ, Any, NA, DefaultDialog),
    9131: (DL_TIER + 3, Start, (CogLevelQuest, Anywhere, 8, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    9132: (DL_TIER + 3, Start, (CogLevelQuest, Anywhere, 7, 6), Any, ToonHQ, Any, NA, DefaultDialog),
    9133: (DL_TIER + 3, Start, (CogLevelQuest, Anywhere, 6, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    9134: (DL_TIER + 3, Start, (CogLevelQuest, Anywhere, 5, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    9135: (DL_TIER + 3, Start, (CogLevelQuest, Anywhere, 4, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    9136: (DL_TIER + 3, Start, (CogLevelQuest, Anywhere, 3, 10), Any, ToonHQ, Any, NA, DefaultDialog),
    9137: (DL_TIER + 3, Start, (CogLevelQuest, Anywhere, 2, 11), Any, ToonHQ, Any, NA, DefaultDialog),
    9138: (DL_TIER + 3, Start, (CogLevelQuest, Anywhere, 1, 12), Any, ToonHQ, Any, NA, DefaultDialog),
    9139: (DL_TIER + 3, Start, (CogTrackQuest, Anywhere, 20, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    9140: (DL_TIER + 3, Start, (CogTrackQuest, Anywhere, 20, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    9141: (DL_TIER + 3, Start, (CogTrackQuest, Anywhere, 20, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    9142: (DL_TIER + 3, Start, (CogTrackQuest, Anywhere, 20, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    9143: (DL_TIER + 3, Start, (CogTrackQuest, Anywhere, 30, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    9144: (DL_TIER + 3, Start, (CogTrackQuest, Anywhere, 30, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    9145: (DL_TIER + 3, Start, (CogTrackQuest, Anywhere, 30, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    9146: (DL_TIER + 3, Start, (CogTrackQuest, Anywhere, 30, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    9147: (DL_TIER + 3, Start, (CogTrackQuest, Anywhere, 40, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    9148: (DL_TIER + 3, Start, (CogTrackQuest, Anywhere, 40, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    9149: (DL_TIER + 3, Start, (CogTrackQuest, Anywhere, 40, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    9150: (DL_TIER + 3, Start, (CogTrackQuest, Anywhere, 40, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    9151: (DL_TIER + 3, Start, (BuildingQuest, Anywhere, 5, Any, 2, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    9152: (DL_TIER + 3, Start, (BuildingQuest, Anywhere, 4, Any, 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    9153: (DL_TIER + 3, Start, (BuildingQuest, Anywhere, 3, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    9154: (DL_TIER + 3, Start, (BuildingQuest, Anywhere, 2, Any, 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    9155: (DL_TIER + 3, Start, (BuildingQuest, Anywhere, 2, Any, 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    9156: (DL_TIER + 3, Start, (BuildingQuest, Anywhere, 2, Any, 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    9157: (DL_TIER + 3, Start, (BuildingQuest, Anywhere, 2, Any, 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    9158: (DL_TIER + 3, Start, (BuildingQuest, Anywhere, 2, Any, 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    9170: (DL_TIER + 3, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    9171: (DL_TIER + 3, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    9172: (DL_TIER + 3, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 30, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    9173: (DL_TIER + 3, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotHQ, 10, 7), Any, ToonHQ, Any, NA, DefaultDialog),
    9174: (DL_TIER + 3, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotHQ, 2, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    9175: (DL_TIER + 3, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotHQ, 1, 14), Any, ToonHQ, Any, NA, DefaultDialog),
    9176: (DL_TIER + 3, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 5, 14), Any, ToonHQ, Any, NA, DefaultDialog),
    9177: (DL_TIER + 3, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 5, 14), Any, ToonHQ, Any, NA, DefaultDialog),
    9178: (DL_TIER + 3, OBSOLETE, (CogLevelQuest, ToontownGlobals.SellbotFactoryInt, 5, 14), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    9182: (DL_TIER + 3, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 25), Any, ToonHQ, Any, NA, DefaultDialog),
    9183: (DL_TIER + 3, OBSOLETE, (SkelecogQuest, ToontownGlobals.SellbotFactoryInt, 20), Any, ToonHQ, Any, NA, DefaultDialog),
    9184: (DL_TIER + 3, OBSOLETE, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 2, 15), Any, ToonHQ, Any, NA, DefaultDialog),
    9185: (DL_TIER + 3, OBSOLETE, (SkelecogLevelQuest, ToontownGlobals.SellbotHQ, 2, 15), Any, ToonHQ, Any, NA, DefaultDialog),
    9186: (DL_TIER + 3, OBSOLETE, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9187: (DL_TIER + 3, OBSOLETE, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9188: (DL_TIER + 3, Start, (BossQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9189: (DL_TIER + 3, Start, (RescueQuest, InVP, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    9201: (DL_TIER + 3, Start, (CogQuest, ToontownGlobals.CashbotHQ, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    9202: (DL_TIER + 3, Start, (CogQuest, ToontownGlobals.CashbotHQ, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    9203: (DL_TIER + 3, Start, (CogQuest, ToontownGlobals.CashbotHQ, 25, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    9204: (DL_TIER + 3, Start, (CogLevelQuest, ToontownGlobals.CashbotHQ, 10, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    9205: (DL_TIER + 3, Start, (CogLevelQuest, ToontownGlobals.CashbotHQ, 4, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    9206: (DL_TIER + 3, Start, (CogLevelQuest, ToontownGlobals.CashbotHQ, 2, 10), Any, ToonHQ, Any, NA, DefaultDialog),
    9207: (DL_TIER + 3, Start, (CogLevelQuest, ToontownGlobals.CashbotMintIntA, 20, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    9208: (DL_TIER + 3, Start, (CogLevelQuest, ToontownGlobals.CashbotMintIntB, 28, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    9209: (DL_TIER + 3, Start, (CogLevelQuest, ToontownGlobals.CashbotMintIntC, 40, 8), Any, ToonHQ, Any, NA, DefaultDialog),
    9210: (DL_TIER + 3, Start, (MintQuest, ToontownGlobals.CashbotMintIntA, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9211: (DL_TIER + 3, Start, (MintQuest, ToontownGlobals.CashbotMintIntB, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9212: (DL_TIER + 3, Start, (MintQuest, ToontownGlobals.CashbotMintIntC, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9213: (DL_TIER + 3, Start, (SkelecogQuest, ToontownGlobals.CashbotMintIntA, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    9214: (DL_TIER + 3, Start, (SkelecogQuest, ToontownGlobals.CashbotMintIntB, 9), Any, ToonHQ, Any, NA, DefaultDialog),
    9215: (DL_TIER + 3, Start, (SkelecogQuest, ToontownGlobals.CashbotMintIntC, 13), Any, ToonHQ, Any, NA, DefaultDialog),
    9216: (DL_TIER + 3, Start, (SupervisorQuest, ToontownGlobals.CashbotMintIntA, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9217: (DL_TIER + 3, Start, (SupervisorQuest, ToontownGlobals.CashbotMintIntB, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9218: (DL_TIER + 3, Start, (SupervisorQuest, ToontownGlobals.CashbotMintIntC, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9219: (DL_TIER + 3, Start, (BossQuest, ToontownGlobals.CashbotHQ, 1), Any, ToonHQ, 622, NA, DefaultDialog),
    ...
    9502: (DL_TIER + 3, Start, (BuildingQuest, Anywhere, 2, Any, 2, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9503: (DL_TIER + 3, Start, (BuildingQuest, Anywhere, 2, Any, 3, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9504: (DL_TIER + 3, Start, (BuildingQuest, Anywhere, 1, 's', 5, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9505: (DL_TIER + 3, Start, (BuildingQuest, Anywhere, 1, 'l', 5, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    9506: (DL_TIER + 3, Start, (RescueQuest, InFO, 3), Any, ToonHQ, Any, NA, DefaultDialog), 
    10100: (ELDER_TIER, Start, (CogQuest, Anywhere, 30, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    10101: (ELDER_TIER, Start, (CogQuest, Anywhere, 30, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    10102: (ELDER_TIER, Start, (CogQuest, Anywhere, 40, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    10103: (ELDER_TIER, Start, (CogQuest, Anywhere, 40, Any), Any, ToonHQ, 613, NA, DefaultDialog),
    10104: (ELDER_TIER, Start, (CogQuest, Anywhere, 50, Any), Any, ToonHQ, 615, NA, DefaultDialog),
    10105: (ELDER_TIER, Start, (CogQuest, Anywhere, 50, Any), Any, ToonHQ, 616, NA, DefaultDialog),
    10106: (ELDER_TIER, Start, (CogQuest, Anywhere, 60, Any), Any, ToonHQ, 618, NA, DefaultDialog),
    10110: (ELDER_TIER, Start, (BuildingQuest, Anywhere, 4, Any, 2, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    10111: (ELDER_TIER, Start, (BuildingQuest, Anywhere, 2, Any, 3, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    10112: (ELDER_TIER, Start, (BuildingQuest, Anywhere, 2, Any, 4, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    10113: (ELDER_TIER, Start, (BuildingQuest, Anywhere, 1, Any, 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    10114: (ELDER_TIER, Start, (BuildingQuest, Anywhere, 1, 'm', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    10115: (ELDER_TIER, Start, (BuildingQuest, Anywhere, 1, 's', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    10116: (ELDER_TIER, Start, (BuildingQuest, Anywhere, 1, 'c', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    10117: (ELDER_TIER, Start, (BuildingQuest, Anywhere, 1, 'l', 5, 0), Any, ToonHQ, Any, NA, DefaultDialog),
    10118: (ELDER_TIER, Start, (BuildingQuest, Anywhere, 5, Any, 1, 0), Any, ToonHQ, 620, NA, DefaultDialog),
    10120: (ELDER_TIER, OBSOLETE, (CogQuest, ToontownGlobals.SellbotHQ, 20, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    10121: (ELDER_TIER, OBSOLETE, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    10122: (ELDER_TIER, OBSOLETE, (ForemanQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    10123: (ELDER_TIER, Start, (BossQuest, ToontownGlobals.SellbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    10124: (ELDER_TIER, Start, (RescueQuest, InVP, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    10125: (ELDER_TIER, Start, (RescueQuest, InFO, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    10140: (ELDER_TIER, Start, (CogQuest, ToontownGlobals.CashbotHQ, 10, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    10141: (ELDER_TIER, Start, (MintQuest, ToontownGlobals.CashbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    10142: (ELDER_TIER, Start, (SupervisorQuest, ToontownGlobals.CashbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    10143: (ELDER_TIER, Start, (BossQuest, ToontownGlobals.CashbotHQ, 1), Any, ToonHQ, 623, NA, DefaultDialog),
    10148: (ELDER_TIER, Start, (BossQuest, ToontownGlobals.LawbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    10149: (ELDER_TIER, Start, (BossQuest, ToontownGlobals.BossbotHQ, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    10150: (ELDER_TIER, Start, (BossQuest, Anywhere, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    10200: (ELDER_TIER, Start, (CogQuest, Anywhere, 20, Any), Any, ToonHQ, NA, 10201, DefaultDialog),
    ...
    10208: (ELDER_TIER, Start, (BuildingQuest, Anywhere, 1, Any, 4, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    10209: (ELDER_TIER, Start, (BuildingQuest, Anywhere, 1, 's', 5, 1), Any, ToonHQ, Any, NA, DefaultDialog),
    10210: (ELDER_TIER, Start, (BuildingQuest, Anywhere, 1, 'l', 5, 1), Any, ToonHQ, Any, NA, DefaultDialog),
...
RewardDict = {
    ...
    500: (MaxQuestCarryReward, 4),
    501: (MaxQuestCarryReward, 4),
    ...
    700: (MaxMoneyReward, 60),
    701: (MaxMoneyReward, 80),
    702: (MaxMoneyReward, 100),
    703: (MaxMoneyReward, 150),
    704: (MaxMoneyReward, 200),
    705: (MaxMoneyReward, 300),
    706: (MaxMoneyReward, 400),
    707: (MaxMoneyReward, 500),
